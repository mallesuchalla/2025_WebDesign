<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="contact.aspx.cs" Inherits="Ditsmart.contact" %>
...
<title>24X7 Live Chat, WhatsApp and Phone Support By Host IT Smart</title>

<meta name="description" content="Contact Host It Smart Now for the best &amp; reliable hosting services with 24*7 support for anything – domain names, website hosting, SSL, Dedicated servers, &amp; VPS hosting.">
<link rel="canonical" href="contact.aspx" />
<link rel="alternate" href="contact.aspx" hreflang="en-in" />
 
<link rel="alternate" hreflang="x-default" href="global.aspxcontact" />  
<link rel="alternate" href="global.aspxcontact" hreflang="en-us" />
<link rel="alternate" href="canada.aspxcontact" hreflang="en-ca" />
<meta name="author" content="">
<meta property="og:url" content="contact.aspx" />
<meta property="og:type" content="website" />
<meta property="og:title" content="24X7 Live Chat, WhatsApp and Phone Support By Host IT Smart" />
<meta property="og:description" content="Contact Host It Smart Now for the best &amp; reliable hosting services with 24*7 support for anything – domain names, website hosting, SSL, Dedicated servers, &amp; VPS hosting." />
<meta property="og:image" content="Images/logo.png" />
<meta name="twitter:card" content="Contact Host It Smart Now for the best &amp; reliable hosting services with 24*7 support for anything – domain names, website hosting, SSL, Dedicated servers, &amp; VPS hosting." />
<meta name="twitter:title" content="24X7 Live Chat, WhatsApp and Phone Support By Host IT Smart" />
<meta name="twitter:url" content="contact.aspx" />
<meta name="twitter:description" content="Contact Host It Smart Now for the best &amp; reliable hosting services with 24*7 support for anything – domain names, website hosting, SSL, Dedicated servers, &amp; VPS hosting." />
...
<script src="JS/bootstrap.bundle.min.js" ></script>
    ...
    <link href="Styles/new-header23.css" rel="stylesheet" />
<link rel="stylesheet" href="Styles/new-header23.css" media="all" />
<link rel="stylesheet" href="Styles/contact-us.css" media="all" />
...
<!-- E 10/6/2020 Vk -->
<div class="banner-inner inner-banner-height" style="background-image:url('../Images/2021-08-13-15-46-59-2018-06-18-14-59-01-vps-hosting-banner.png')">
    ...
    <div class="container">		
        ...
        <div class="banner-content">
            ...
            <span class="banner-subtitle aos-init" data-aos="fade-up" data-aos-delay="200">
                ...
                <p>Have any queries or questions? Let us solve them for you...!!! Help us in helping you with your needs.</p>
        ...
        <div class="row">	
            <div class="col-lg-6 col-12 left_part d-flex justify-content-end">
                <div class="contact-left aos-init" data-aos="fade-right">	
                    ...
                    <form method="POST" action="contact.aspx" accept-charset="UTF-8" class="form-horizontal row contact_form" name="contact_form" autocomplete="off" id="contact_form"><input name="_token" type="hidden" value="EHRRPkGgW4JzPRZcZDT8jCb0J9bcMAF5YS6b2BBN">
                    <input name="varRefURL" type="hidden" value="about_us.aspx">
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            <label class="form-text" for="cname">Name<span class="required">*</span></label>
                            <input id="first_name" class="form-control" pattern="[a-zA-Z\s]+" name="first_name" type="text">
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            ...
                            <input id="contact_email" class="form-control" name="contact_email" type="text">
                                                    </div>
                    </div>
                    <div class="col-md-6 col-12">
                        <div class="form-group"> 
                            <label class="form-text" for="ccall">Phone #<span class="required">*</span></label>
                            <input id="phone_no" class="form-control" maxlength="20" onpaste="return false;" ondrop="return false;" onkeypress="javascript: return KeycheckOnlyPhonenumber(event);" name="phone_number" type="tel">
                                                    </div>
                    </div>
                    <div class="col-md-6 col-12">
                        <div class="form-group"> 
                            <label class="form-text" for="ccat">Choose Category<span class="required">*</span></label>
                            <select id="var_Category" name="var_Category" class="form-control"><option value=''>Choose Category</option><option value="1">Sales and Support</option><option value="2">Technical Support</option><option value="3">Billing Department</option><option value="4">AWS Supports Leads</option></select>
                    ...
                    <div class="col-12">
                        <div class="form-group">  
                            ...
                            <textarea class="form-control" cols="40" rows="3" pattern="[a-zA-Z\s]+" id="user_message" spellcheck="true" name="user_message"></textarea>
                        </div>
                    </div>
                   <div class="col-md-6 col-12">
                        <div class="form-group">
                    ...
                    <div class="col-12">
                    	<div class="form-group text-center">        
                    		By clicking "Send a message", you agree to our <a target="_blank" title="Privacy Policy" href="https://genbaseerp.com/privacy-policy">Privacy Policy</a>.
                    	</div>
                    </div>
                    ...
                    <div class="contact-details">
                        <div class="row">
                                ...
                                <i class="fa-solid fa-phone"></i>
                                    ...
                                    <a href="tel:079-3507-9700" class="contact-text" title="079-3507-9700">079-3507-9700</a>
                                </div>
                            </div>
                                ...
                                <i class="fa-solid fa-envelope"></i>
                                    ...
                                    <a href="mailto:info@hostitsmart.com" class="contact-text" title="info@hostitsmart.com">info@hostitsmart.com</a>
                                </div>
                            </div>
                                                                                    <div class="col-md-6" data-aos="fade-right">
                                <div class="contact-box-1">	
                                <i class="fa-solid fa-location-dot"></i>
                                    ...
                                    <span class="c-address contact-text">
                                        608, Mauryansh Elanza, <br />
Near Shyamal Cross Road, Satellite, <br />
Ahmedabad - 15, <br />
Gujarat, (INDIA)    
                                    </span>
                                </div>
                                ...
                                <i class="fa-solid fa-heart"></i>
                                    ...
                                    <ul class="social">
                                                                                <li><a href="https://www.facebook.com/hostitsmart" target="_blank" title="Facebook" class="d-flex justify-content-center fb"><i class="fa fa-facebook"></i> <span class="bg-color"></span></a></li>
                                                                                                                                                                <li><a href="https://twitter.com/hostitsmart" title="Twitter" target="_blank" class="d-flex justify-content-center twitter"><i class="fa-brands fa-x-twitter"></i> <span class="bg-color"></span></a></li>
                                                                                                                        <li><a href="https://www.pinterest.com/hostitsmart/" title="Pinterest" target="_blank" class="d-flex justify-content-center pinterest"><i class="fa fa-pinterest-p"></i> <span class="bg-color"></span></a></li>
                                                                                                                        <li><a href="https://www.linkedin.com/company/host-it-smart/" title="Linkedin" target="_blank" class="d-flex justify-content-center linkedin"><i class="fa fa-linkedin"></i> <span class="bg-color"></span></a></li>
                                                                                                                        <li><a href="https://www.instagram.com/hostitsmart/" title="Instagram" target="_blank" class="d-flex justify-content-center instagram"><i class="fa fa-instagram"></i> <span class="bg-color"></span></a></li>
                                                                            </ul>
                                </div>
                            </div>
                            ...
                            <div class="col-6 d-xs-flex">
                                                              <a href="clientarea.aspx" title="Click Here"> <div class="ticket" data-aos="fade-left">
                                    <span></span>
                                    <p>Submit a Ticket</p>
                                </div></a>
                            </div>
								...
								<div class="whatsapp" data-aos="fade-left">
                                    <a href="send.aspx?phone=9652629002" title="Click Here">
									<span></span>
...
<script>
    ...
    const globalRequestParamOne = 'contact';
