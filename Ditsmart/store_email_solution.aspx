<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="store_email_solution.aspx.cs" Inherits="Ditsmart.store_email_solution" %>
    ...
    <div class="row">
                ...
                <i class="fas fa-chevron-up card-minimise panel-minimise pull-right float-right"></i>
                    ...
                    <div class="list-group collapsable-card-body">
                            ...
                            Dedicated Servers
                                                                                ...
                                                                                <a menuItemName="Email Solution" href="store_email_solution.aspx" class="list-group-item list-group-item-action active" id="Secondary_Sidebar-Categories-Email_Solution">
        ...
        <div class="panel-heading card-header">
            <h3 class="panel-title">
                ...
                <form method="post" action="store_email_solution.aspx">
        ...
        <form role="form">
            <select class="form-control custom-select" onchange="selectChangeNavigate(this)">
                        ...
                        Dedicated Servers
                                                        ...
                                                        <option menuItemName="Email Solution" value="store_email_solution.aspx" class="list-group-item" selected="selected">
                        Email Solution
            ...
            <div class="products" id="products">
                <div class="row row-eq-height">
                        ...
                        <div class="product clearfix" id="product207">
                            <header>
                                <span id="product207-name">Microsoft 365 Business Basic</span>
                                                            </header>
                            <div class="product-desc">
                                                                    <p id="product207-description">
                                        Unlimited Storage (or 1TB per user if fewer than 5 users)<br /><br />
Advanced admin controls for Drive<br /><br />
Audit and reporting insights for Drive content and sharing<br /><br />
Google Vault for eDiscovery covering emails, chats, docs and files<br /><br />
Easily search and export to different formats<br /><br />
Archive all emails sent by your company<br /><br />
Set message retention policies<br /><br />
Place and enforce litigation holds on inboxes<br /><br />
                            ...
                            <footer>
                                <div class="product-pricing" id="product207-price">
                                                                                                                    <span class="price">INR 142.50</span>
                                        <br />
                                                                                    Monthly
                                                                                <br>
                                                                                                            </div>
                                <a href="store_email_solution.aspx/microsoft-365-business-basic" class="btn btn-success btn-sm" id="product207-order-button">
                                    <i class="fas fa-shopping-cart"></i>
                                    Order Now
                                </a>
                            </footer>
                        ...
                        <div class="product clearfix" id="product208">
                            <header>
                                <span id="product208-name">Microsoft 365 Business Premium</span>
                                                            </header>
                            <div class="product-desc">
...
Place and enforce litigation holds on inboxes<br /><br />
                            ...
                            <footer>
                                <div class="product-pricing" id="product208-price">
                                                                                                                    <span class="price">INR 1,700.00</span>
                                        <br />
                                                                                    Monthly
                                                                                <br>
                                                                                                            </div>
                                <a href="store_email_solution.aspx/microsoft-365-business-premium" class="btn btn-success btn-sm" id="product208-order-button">
                                    <i class="fas fa-shopping-cart"></i>
                                    Order Now
                                </a>
                            </footer>
                ...
                <div class="row row-eq-height">
                        ...
                        <div class="product clearfix" id="product209">
                            <header>
                                <span id="product209-name">Microsoft 365 Business Standard</span>
                                                            </header>
                            <div class="product-desc">
                                                                    <p id="product209-description">
                                        50 GB mailbox<br />
1 TB OneDrive storage<br />
Applications - Outlook/Word/Excel/Powerpoint/Access(PC only)<br />
Services - OneDrive<br />
24/7 Support<br />
Maximum 300 Users<br />
Communicate and manage work with Firstline workers with Microsoft Kaizala<br />
Installed apps 5 phones, 5 tablets, and 5 PCs or Macs per user<br />
                            ...
                            <footer>
                                <div class="product-pricing" id="product209-price">
                                                                                                                    <span class="price">INR 725.00</span>
                                        <br />
                                                                                    Monthly
                                                                                <br>
                                                                                                            </div>
                                <a href="store_email_solution.aspx/microsoft-365-business-standard" class="btn btn-success btn-sm" id="product209-order-button">
                                    <i class="fas fa-shopping-cart"></i>
                                    Order Now
                                </a>
                            </footer>
                        ...
                        <div class="product clearfix" id="product117">
                            <header>
                                <span id="product117-name">Google Workspace Business Starter</span>
                                                            </header>
                            <div class="product-desc">
...
Place and enforce litigation holds on inboxes<br /><br />
                            ...
                            <footer>
                                <div class="product-pricing" id="product117-price">
                                                                                                                    <span class="price">INR 150.00</span>
                                        <br />
                                                                                    Monthly
                                                                                <br>
                                                                                                            </div>
                                <a href="store_email_solution.aspx/google-workspace-business-starter" class="btn btn-success btn-sm" id="product117-order-button">
                                    <i class="fas fa-shopping-cart"></i>
                                    Order Now
                                </a>
                            </footer>
                ...
                <div class="row row-eq-height">
                        ...
                        <div class="product clearfix" id="product116">
                            <header>
                                <span id="product116-name">Google Workspace Business Standard</span>
                                                            </header>
                            <div class="product-desc">
                                                                    <p id="product116-description">
                                        Business email addresses (name@yourcompany.com) <br /><br />
Video and voice calls <br /><br />
Integrated online calendars <br /><br />
30GB of online storage for file syncing and sharing <br /><br />
Online text documents, spreadsheets and slides <br /><br />
Easy to create project sites <br /><br />
Security and admin controls <br /><br />
24/7 phone and email support <br /><br />
                            ...
                            <footer>
                                <div class="product-pricing" id="product116-price">
                                                                                                                    <span class="price">INR 810.00</span>
                                        <br />
                                                                                    Monthly
                                                                                <br>
                                                                                                            </div>
                                <a href="store_email_solution.aspx/google-workspace-business-standard" class="btn btn-success btn-sm" id="product116-order-button">
                                    <i class="fas fa-shopping-cart"></i>
                                    Order Now
                                </a>
                            </footer>
                        ...
                        <div class="product clearfix" id="product206">
                            <header>
                                <span id="product206-name">Google Workspace Business Plus</span>
                                                            </header>
                            <div class="product-desc">
...
24/7 phone and email support <br /><br />
                            ...
                            <footer>
                                <div class="product-pricing" id="product206-price">
                                                                                                                    <span class="price">INR 1,520.00</span>
                                        <br />
                                                                                    Monthly
                                                                                <br>
                                                                                                            </div>
                                <a href="store_email_solution.aspx/google-workspace-business-plus" class="btn btn-success btn-sm" id="product206-order-button">
                                    <i class="fas fa-shopping-cart"></i>
                                    Order Now
                                </a>
                            </footer>
