<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="#collapse15.aspx.cs" Inherits="Ditsmart.Collapse._collapse15" %>
...
<!-- <link rel="stylesheet" href="https://d1neo0gtmjcot5.cloudfront.net/assets/theme_v1/home_theme_v1.css?v=202502190148" media="all" /> -->
<link rel="preload" as="image" href="Images/black-friday-bnnr2.png">
<link rel="preload" as="image" href="Images/black-friday-BG.png">
<link rel="stylesheet" href="https://genbaseerp.com/assets/css/custom.css?v=202502190148" media="all" />
<link rel="stylesheet" href="/assets/css/common.css?v=202502190148" media="all" />


<link rel="stylesheet" href="https://d1neo0gtmjcot5.cloudfront.net/assets/css/domain-landing.css?v=202502190148" media="all" />
...
<link rel="stylesheet" href="https://genbaseerp.com/assets/css/new-header23.css?v=202502190148" media="all" />
<link rel="stylesheet" href="assets/css/homepage.css?v=202502190148"/>
<link href="Styles/bootstrap.min.css" rel="stylesheet">
     <script src="JS/popper.min.js" ></script>
     <script src="JS/bootstrap.min.js" ></script>
...
<div class="  -home-banner">
        ...
        <div >
            ...
            <link rel="stylesheet" href="https://genbaseerp.com/assets/css/diwali-23-banner.css?v=202502190148">
...
<a class="btn-started" href="#services_section_plan">GET STARTED</a> <a class="chat-box-btn" href="javascript:void(Tawk_API.toggle())" id="chat-btn-home" title="Chat With Us">Chat With Us</a></div>
</div>

<div class="col-lg-6">
<div class="bnnr-wbh-right bnnr-wbh-cstm"><img width="800" height="600" alt="Hero-Banner-img" class="img-fluid" loading="eager" src="Images/Hero-Banner-img.png" /></div>
</div>
</div>
...
<div class="cst-rtg-tittle"><img alt="hostadvice" loading="lazy" src="Images/hostadvice-logo.png" /></div>

<div class="cst-rtg-star"><img alt="star-icon" loading="lazy" src="Images/star-icon.png" /> <img alt="star-icon" loading="lazy" src="Images/star-icon.png" /> <img alt="star-icon" loading="lazy" src="Images/star-icon.png" /> <img alt="star-icon" loading="lazy" src="Images/star-icon.png" /></div>
...
<div class="cst-rtg-tittle"><img alt="trustpilot" loading="lazy" src="Images/trustpilot-logo.png" /></div>
...
<div class="cst-rtg-tittle"><img alt="google" loading="lazy" src="Images/google-logo.png" /></div>
            ...
            <div class="col-sm-12">
                <div class="domain-search-wrap">
                    ...
                    <form class="domain-search-form" id="domainlookupfrm" onsubmit="margetlds()" autocomplete="off" name="domainlookupfrm" action="domain_checker.aspx" method="post" novalidate="novalidate">
                        ...
                        <div class="">
                            <button type="submit" class="btn btn-brand-01 dsf-button" style="border-radius: 30px"><img src="Images/search.png" alt="search"></button>
                        </div>
                    </form>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="box" data-aos="fade-down" data-aos-delay="600" >
                    ...
                    <div class="package-title-fw text-center"> <span> LINUX </span>HOSTING </div></a>
                    </div>
...
<p class="small mb-2"> Economical</p>
                        ...
                        <div class="pricing-price pt-4">
                            ...
                            <div class="home-page-plans-cutprice line-through">
                                <span class="small">₹225</span><span class="price-cycle">/mo</span> <br>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="box" data-aos="fade-down" data-aos-delay="300" >
                    ...
                    <div class="package-title-fw text-center"> <span> WORDPRESS </span>HOSTING </div></a>
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="box" data-aos="fade-down" data-aos-delay="100" >
                    ...
                    <div class="package-title-fw text-center"> <span> WINDOWS </span>HOSTING </div></a>
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="box" data-aos="fade-down" data-aos-delay="100" >
                    ...
                    <div class="package-title-fw text-center"> <span> VPS </span>Hosting </div></a>
                    </div>
                       <div class="package-title-pw">Great Server Performance at Affordable Costs</div>
                        ...
                        <div class="pricing-price pt-4">
                            <small>Starting at</small>
                            <div class="home-page-plans-cutprice line-through">
                                <span class="small">₹720</span><span class="price-cycle">/mo</span> <br>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="box" data-aos="fade-down" data-aos-delay="300" >
                    ...
                    <div class="package-title-fw text-center"> <span> Windows </span>VPS     Hosting
</div></a>
                    </div>
                       <div class="package-title-pw"> Benefit of Power & Flexibility at the best costs</div>
                        ...
                        <div class="pricing-price pt-4">
                            <small>Starting at</small>
                            <div class="home-page-plans-cutprice line-through">
                                <span class="small">₹1300</span><span class="price-cycle">/mo</span> <br>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="box" data-aos="fade-down" data-aos-delay="600" >
                    ...
                    <div class="package-title-fw text-center"> <span> Dedicated </span>Servers </div></a>
                    </div>
                       <div class="package-title-pw"> With great Server Autonomy comes great performance!</div>
                        ...
                        <div class="pricing-price pt-4">
                            <small>Starting at</small>
                            <div class="home-page-plans-cutprice line-through">
                                <span class="small">₹4218</span><span class="price-cycle">/mo</span> <br>
...
</section>    <div class="feature-section ptb-60">
    <div class="container">
...
<!-- testimonials-carousel-E -->    <!-- <div class="partners-section">
	<div class="container"> 
...
<div id="browsernote" style="display:none;position:fixed;width:100%;height:100%;background:rgba(0,0,0,0.8);z-index:9999;top:0;left:0;font-size:18px;">
    <div style="font-size:18px;color:#fff;background:#18b35c;padding:15px;text-align:center;height:60px;z-index:9999;position:fixed;width:100%;top:0;margin:auto;">For a better experience on <strong style="color:#000;">Host IT Smart,</strong><a href="https://support.apple.com/downloads" style="cursor:pointer;color: #ffffff;font-size:14px;margin-left:10px;display:inline-block;" target="_blank">update your browser.</a>
        ...
        <!-- Main Wrapper E -->
                <!-- <script src="https://d1neo0gtmjcot5.cloudfront.net/assets/theme_v1/main_theme_v1.js?v=202502190148"></script> -->
...
<script src="assets/js/common_v12.js?v=202502190148" type="text/javascript" ></script>
...
document.addEventListener("DOMContentLoaded",function(){let e=document.querySelectorAll(".accordion-toggle");e.forEach(t=>{t.addEventListener("click",function(){if(window.innerWidth<=992){e.forEach(e=>{e!==t&&(e.classList.remove("active"),e.nextElementSibling.style.display="none")}),this.classList.toggle("active");let i=this.nextElementSibling;"block"===i.style.display?i.style.display="none":i.style.display="block"}})}),window.addEventListener("resize",function(){window.innerWidth>992&&e.forEach(e=>{e.classList.remove("active");let t=e.nextElementSibling;t.style.display=""})})});
    ...
    <!-- footer-menu-for-mobile-view-e -->            
            ...
            <script src="https://genbaseerp.com/assets/js/custom.js?v=202502190148"></script>
