<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="whois.aspx.cs" Inherits="Ditsmart.whois" %>
...
<title>WHOIS Domain Lookup - Check Domain Availability &amp; Info</title>

<meta name="description" content="Get verified registration information using this tool you can find out who registered a domain.">
<link rel="canonical" href="whois.aspx" />
<link rel="alternate" href="whois.aspx" hreflang="en-in" />
 
<link rel="alternate" hreflang="x-default" href="global.aspxwhois" />  
<link rel="alternate" href="global.aspxwhois" hreflang="en-us" />
<meta name="author" content="">
<meta property="og:url" content="whois.aspx" />
<meta property="og:type" content="website" />
<meta property="og:title" content="WHOIS Domain Lookup - Check Domain Availability &amp; Info" />
<meta property="og:description" content="Get verified registration information using this tool you can find out who registered a domain." />
<meta property="og:image" content="Images/logo.png" />
<meta name="twitter:card" content="Get verified registration information using this tool you can find out who registered a domain." />
<meta name="twitter:title" content="WHOIS Domain Lookup - Check Domain Availability &amp; Info" />
<meta name="twitter:url" content="whois.aspx" />
<meta name="twitter:description" content="Get verified registration information using this tool you can find out who registered a domain." />
...
<!-- <link rel="stylesheet" href="https://d1neo0gtmjcot5.cloudfront.net/assets/theme_v1/main_theme_v1.css?v=202502190115" media="all" /> -->
<link rel="stylesheet" href="https://genbaseerp.com/assets/css/custom.css?v=202502190115" media="all" />
<link rel="stylesheet" href="/assets/css/common.css?v=202502190115" media="all" />


<link rel="stylesheet" href="https://d1neo0gtmjcot5.cloudfront.net/assets/css/domain-landing.css?v=202502190115" media="all" />
...
<link rel="stylesheet" href="https://genbaseerp.com/assets/css/new-header23.css?v=202502190115" media="all" />
<link rel="stylesheet" href="assets/css/whois.css?v=202502190115"/>
<link href="Styles/bootstrap.min.css" rel="stylesheet">
     <script src="JS/popper.min.js" ></script>
     <script src="JS/bootstrap.min.js" ></script>
...
<!-- </whatsapp-icon-hide-s> -->
    ...
    <div class="banner-inner whois-banner" style="background-image:url(https://genbaseerp.com/assets/images/whois-b.jpg)">
        <div class="container">		
            <div class="banner-content">
                ...
                <div class="banner-search aos-init" data-aos="fade-up" data-aos-delay="400">
                    <form method="POST" action="whois.aspx" accept-charset="UTF-8" class="custom-search" autocomplete="off" name="whois" id="whois"><input name="_token" type="hidden" value="EHRRPkGgW4JzPRZcZDT8jCb0J9bcMAF5YS6b2BBN">
                    <input id="domainwhois" autocomplete="off" class="form-control" placeholder="Search for a Domain Name" name="domainwhois" type="text">
                ...
                <div class="banner-button aos-init" data-aos="fade-up" data-aos-delay="500">
                    <a class="" title="Domain Registration" href="domain_registration.aspx">Domain Registration</a>
                    <a class="" title="Transfer Domain" href="domain_transfer.aspx">Transfer Domain</a>
                    <a class="" title="Renew Domain" href="https://genbaseerp.com/domain-privacy-protection">Domain Privacy</a>
                </div>
            </div>
        </div>
    </div>
    <script type="text/javascript">
        ...
        <div class="container">
            <div class="bg-design">
                <div class="row">
<div class="col-sm-12">
<div class="whois-content cms" data-aos="fade-up">
<h2>What is the WHOIS database?</h2>

<p>The WHOIS domain database is a listing of all registered domains, and is regularly used for various legal purposes. Network administrators use WHOIS data to identify and fix problems. For instance, WHOIS information can be used to determine the availability of domain names, identify trademark infringement, and keep domain name registrants accountable.</p>

<p>WHOIS verification can even be utilized to combat spam or fraud, as administrators can track down registrants who post illegal content or participate in phishing scams. In addition, the agreements from The International Corporation for Assigned Names and Numbers (ICANN) protects domain registrants by prohibiting the use of WHOIS listings for marketing or spam purposes, including high-volume, automated queries against a specific registrar or registry system (unless such queries are done with the intent to manage domain names). For more information on this, read our helpful guide to navigating WHOIS.</p>
</div>
</div>

<div class="col-sm-12">
<div class="whois-content cms" data-aos="fade-up">
<h3>How can I use the WHOIS Lookup Tool?</h3>

<p>Using the HostItSmart WHOIS domain lookup tool is easy. You can simply enter the domain name whose information you&#39;d like to view into the search field on the WHOIS main page. You can retrieve key data about a domain in this way, including availability, ownership, creation, and expiration details. If you own multiple domains of your own, it can be helpful to download exportable lists from the tool in order to analyze large amounts of domains data. Our guide to prioritizing and valuing domain names can help you navigate how to best use and organize the information you download.</p>
</div>
</div>

<div class="col-sm-12">
<div class="whois-content cms" data-aos="fade-up">
<h3>How accurate is WHOIS data?</h3>

<p>Since registrants&#39; contact data can change, registrars such as HostItSmart must provide annual opportunities for domain owners to review and edit their WHOIS domain data. According to ICANN&#39;s rules, refusing to update this information or providing false data can lead to the suspension or cancellation of domains.</p>

<p>In addition, ICANN allows Internet users to file complaints if they discover WHOIS domain name lookup data that is incorrect or incomplete. In such instances, registrars must correct and verify the data in a timely manner. Through this verification protocol, ICANN seeks to maintain the highest possible level of accuracy.</p>
</div>
</div>

<div class="col-sm-12">
<div class="whois-content cms" data-aos="fade-up">
<h3>How do I update my WHOIS information?</h3>

<p>It&#39;s easy to update your WHOIS contact information in the Domain Manager of your HostItSmart account. It&#39;s only takes a few simple steps, and you can update all your contacts at once, or just one at a time. It&#39;s important to always keep your contact information up to date, both to comply with ICANN regulations and to make certain you&#39;re receiving correspondence at the correct email address.</p>
</div>
</div>
...
<p>While ICANN&#39;s agreements protect registrants from potential spam, many HostItSmart customers still express concern about their personal name, address, and phone number being so readily available online. For website owners who would prefer to keep such information private, HostItSmart offers Domain Privacy protection, so that when people do a WHOIS search on your domain, we replace your personal information with proxy information (check out the difference). When we do this, your domain name is still yours, but now people won&#39;t be able to discover your personal information through a simple WHOIS lookup.</p>

<p>Furthermore, if you&#39;re a web developer, you have an important obligation to your clients to offer them a complete sense of privacy and protection, no matter the scope of your project. We have some great tips on bolstering both privacy and security for your client base.</p>
</div>
</div>
</div>
            </div>
...
<div id="browsernote" style="display:none;position:fixed;width:100%;height:100%;background:rgba(0,0,0,0.8);z-index:9999;top:0;left:0;font-size:18px;">
    <div style="font-size:18px;color:#fff;background:#18b35c;padding:15px;text-align:center;height:60px;z-index:9999;position:fixed;width:100%;top:0;margin:auto;">For a better experience on <strong style="color:#000;">Host IT Smart,</strong><a href="https://support.apple.com/downloads" style="cursor:pointer;color: #ffffff;font-size:14px;margin-left:10px;display:inline-block;" target="_blank">update your browser.</a>
        ...
        <!-- Main Wrapper E -->
                <!-- <script src="https://d1neo0gtmjcot5.cloudfront.net/assets/theme_v1/main_theme_v1.js?v=202502190115"></script> -->
...
<script src="assets/js/common_v12.js?v=202502190115" type="text/javascript" ></script>
...
document.addEventListener("DOMContentLoaded",function(){let e=document.querySelectorAll(".accordion-toggle");e.forEach(t=>{t.addEventListener("click",function(){if(window.innerWidth<=992){e.forEach(e=>{e!==t&&(e.classList.remove("active"),e.nextElementSibling.style.display="none")}),this.classList.toggle("active");let i=this.nextElementSibling;"block"===i.style.display?i.style.display="none":i.style.display="block"}})}),window.addEventListener("resize",function(){window.innerWidth>992&&e.forEach(e=>{e.classList.remove("active");let t=e.nextElementSibling;t.style.display=""})})});
    ...
    <!-- footer-menu-for-mobile-view-e -->            
            ...
            <script src="https://genbaseerp.com/assets/js/custom.js?v=202502190115"></script>
...
<script>
    ...
    const globalRequestParamOne = 'whois';
