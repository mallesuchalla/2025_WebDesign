<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="clientarea.aspx.cs" Inherits="Ditsmart.clientarea" %>
...
<head>
    ...
    <title>Client Area - Host IT Smart</title>

    <!-- Styling -->
    <link href="clientarea_styles/css.css" rel="stylesheet" />
    <link href="clientarea_styles/all.min.css" rel="stylesheet" />
    <link href="clientarea_styles/fontawesome-all.min.css" rel="stylesheet" />
...
<script type="text/javascript">
    ...
    <script src="clientarea_styles/scripts.min.js"></script>
...
<section id="header">
    <div class="container">
        <ul class="top-nav">
                    ...
                    <a href="clientaria_cart.aspx?a=view" class="btn">
                        View Cart
                    </a>
                </li>
                                </ul>

                    <a href="index.aspx" class="logo"><img src="Images/logo.png" alt="Host IT Smart"></a>
...
<section id="main-menu">
    ...
    <li menuItemName="Store" class="dropdown" id="Primary_Navbar-Store">
        <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                    ...
                    <a href="store_windows_hosting.aspx?gid=19">
                                                Windows Hosting
                                            </a>
                </li>
                            <li menuItemName="Linux Hosting" id="Primary_Navbar-Store-Linux_Hosting">
                    <a href="store_linux_hosting.aspx?gid=1">
                                                Linux Hosting
                                            </a>
                </li>
                            <li menuItemName="Linux Reseller Hosting" id="Primary_Navbar-Store-Linux_Reseller_Hosting">
                    <a href="store_linux_reseller_hosting.aspx?gid=7">
                                                Linux Reseller Hosting
                                            </a>
                </li>
                            <li menuItemName="E-Commerce Hosting" id="Primary_Navbar-Store-E-Commerce_Hosting">
                    <a href="store_e_commerce_hosting.aspx?gid=29">
                                                E-Commerce Hosting
                                            </a>
                </li>
                            <li menuItemName="WordPress Hosting" id="Primary_Navbar-Store-WordPress_Hosting">
                    <a href="store_wordpress_hosting.aspx?gid=27">
                                                WordPress Hosting
                                            </a>
                </li>
                            <li menuItemName=" Linux Self-Managed VPS Hosting " id="Primary_Navbar-Store-_Linux_Self-Managed_VPS_Hosting_">
                    <a href="store_linux_self_managed_vps_hosting.aspx?gid=46">
...
<div class="logincontainer">
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <form method="post" action="clientarea.aspx" class="login-form" role="form">
<input type="hidden" name="token" value="c1e903029857831121efa0296192bc552fe233e1" />
                ...
                <div id="default-captcha-domainchecker" class="text-center">
                    ...
                    <div class="col-xs-6 captchaimage">
                        <img id="inputCaptchaImage" data-src="Images/verifyimage.png" src="Images/verifyimage.png" align="middle" />
                    </div>
...
<div id="fullpage-overlay" class="hidden">
    <div class="outer-wrapper">
        <div class="inner-wrapper">
            <img src="Images/overlay-spinner.png">
            <br>
            <span class="msg"></span>
        </div>
    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-4">
                            ...
                            <button type="button" class="btn btn-default btn-sm copy-to-clipboard" data-clipboard-target="#inputGeneratePasswordOutput">
                                <img src="Images/clippy.png" alt="Copy to clipboard" width="15">
