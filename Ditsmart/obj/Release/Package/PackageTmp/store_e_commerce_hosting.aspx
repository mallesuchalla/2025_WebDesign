<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="store_e_commerce_hosting.aspx.cs" Inherits="Ditsmart.store_e_commerce_hosting" %>
    ...
    <div class="row">
                ...
                <i class="fas fa-chevron-up card-minimise panel-minimise pull-right float-right"></i>
                    ...
                    <div class="list-group collapsable-card-body">
                            ...
                            Linux Reseller Hosting
                                                                                ...
                                                                                <a menuItemName="E-Commerce Hosting" href="store_e_commerce_hosting.aspx" class="list-group-item list-group-item-action active" id="Secondary_Sidebar-Categories-E-Commerce_Hosting">
        ...
        <div class="panel-heading card-header">
            <h3 class="panel-title">
                ...
                <form method="post" action="store_e_commerce_hosting.aspx">
        ...
        <form role="form">
            <select class="form-control custom-select" onchange="selectChangeNavigate(this)">
                        ...
                        Linux Reseller Hosting
                                                        ...
                                                        <option menuItemName="E-Commerce Hosting" value="store_e_commerce_hosting.aspx" class="list-group-item" selected="selected">
                        E-Commerce Hosting
            ...
            <div class="products" id="products">
                <div class="row row-eq-height">
                            ...
                            <div class="product clearfix" id="product1">
                                <header>
                                    <span id="product1-name">eCommerce Hosting - BASIC</span>
                                                                    </header>
                                <div class="product-desc">
                                                                            <p id="product1-description">
                                            1 Website<br />
1 GB SSD Disk Space<br />
Free SSL<br />
Plesk<br />
...
5 FTP users<br />
                                ...
                                <footer>
                                    ...
                                    <a href="cart.php?a=add&pid=429" class="btn btn-success btn-sm" id="product1-order-button">
                            ...
                            <div class="product clearfix" id="product2">
                                <header>
                                    <span id="product2-name">eCommerce Hosting - ESSENTIAL</span>
                                                                    </header>
                                <div class="product-desc">
...
Unlimited  FTP users<br />
                                ...
                                <footer>
                                    ...
                                    <a href="cart.php?a=add&pid=430" class="btn btn-success btn-sm" id="product2-order-button">
                                        <i class="fa fa-shopping-cart"></i>
                                        Order Now
                                    </a>
                                </footer>
                            ...
                            <div class="product clearfix" id="product3">
                                <header>
                                    <span id="product3-name">eCommerce Hosting - PROFESSIONAL</span>
                                                                    </header>
                                <div class="product-desc">
...
Unlimited  FTP users<br />
                                ...
                                <footer>
                                    ...
                                    <a href="cart.php?a=add&pid=431" class="btn btn-success btn-sm" id="product3-order-button">
                                        <i class="fa fa-shopping-cart"></i>
                                        Order Now
                                    </a>
                                </footer>
                            ...
                            <div class="product clearfix" id="product4">
                                <header>
                                    <span id="product4-name">eCommerce Hosting - ENTERPRISE</span>
                                                                    </header>
                                <div class="product-desc">
                                                                            <p id="product4-description">
                                            Unlimited Website<br />
...
Unlimited  FTP users<br />
                                ...
                                <footer>
                                    ...
                                    <a href="cart.php?a=add&pid=432" class="btn btn-success btn-sm" id="product4-order-button">
                                        <i class="fa fa-shopping-cart"></i>
                                        Order Now
                                    </a>
                                </footer>
