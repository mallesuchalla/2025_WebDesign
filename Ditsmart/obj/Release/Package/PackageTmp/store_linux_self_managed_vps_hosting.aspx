<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="store_linux_self_managed_vps_hosting.aspx.cs" Inherits="Ditsmart.store_linux_self_managed_vps_hosting" %>
    ...
    <div class="row">
                ...
                <i class="fas fa-chevron-up card-minimise panel-minimise pull-right float-right"></i>
                    ...
                    <div class="list-group collapsable-card-body">
                            ...
                            WordPress Hosting
                                                                                ...
                                                                                <a menuItemName=" Linux Self-Managed VPS Hosting " href="store_linux_self_managed_vps_hosting.aspx" class="list-group-item list-group-item-action active" id="Secondary_Sidebar-Categories-_Linux_Self-Managed_VPS_Hosting_">
        ...
        <div class="panel-heading card-header">
            <h3 class="panel-title">
                ...
                <form method="post" action="store_linux_self_managed_vps_hosting.aspx">
        ...
        <form role="form">
            <select class="form-control custom-select" onchange="selectChangeNavigate(this)">
                        ...
                        WordPress Hosting
                                                        ...
                                                        <option menuItemName=" Linux Self-Managed VPS Hosting " value="store_linux_self_managed_vps_hosting.aspx" class="list-group-item" selected="selected">
                         Linux Self-Managed VPS Hosting 
...
<input type="hidden" name="token" value="355c8b17c5ff5bc477697c7cd60dc1ba71093fd0" />
            ...
            <div class="products" id="products">
                <div class="row row-eq-height">
                                                                <div class="col-md-6">
                        <div class="product clearfix" id="product508">
                            <header>
                                <span id="product508-name">LIN VPS - SM 1 - 2025</span>
                                                            </header>
                            <div class="product-desc">
                                                                    <p id="product508-description">
                                        1 vCPU core<br />
4 GB RAM<br />
50 GB SSD<br />
4 TB bandwidth<br />
1 Dedicated IP<br />
                            ...
                            <footer>
                                <div class="product-pricing" id="product508-price">
                                                                                                                        Starting from
                                            <br />
                                                                                <span class="price">INR 462.00</span>
                                        <br />
                                                                                    Monthly
                                                                                <br>
                                                                                                            </div>
                                <a href="store_linux_self_managed_vps_hosting.aspx/lin-vps-sm-1-2025" class="btn btn-success btn-sm" id="product508-order-button">
                                    <i class="fas fa-shopping-cart"></i>
                                    Order Now
                                </a>
                            </footer>
                                                                                    ...
                                                                                    <div class="col-md-6">
                        <div class="product clearfix" id="product509">
                            <header>
                                <span id="product509-name">LIN VPS - SM 2 - 2025</span>
                                                            </header>
                            <div class="product-desc">
                                                                    <p id="product509-description">
                                        2 vCPU cores<br />
8 GB RAM<br />
100 GB SSD<br />
8 TB bandwidth<br />
                            ...
                            <footer>
                                <div class="product-pricing" id="product509-price">
                                                                                                                        Starting from
                                            <br />
                                                                                <span class="price">INR 600.00</span>
                                        <br />
                                                                                    Monthly
                                                                                <br>
                                                                                                            </div>
                                <a href="store_linux_self_managed_vps_hosting.aspx/lin-vps-sm-2-2025" class="btn btn-success btn-sm" id="product509-order-button">
                                    <i class="fas fa-shopping-cart"></i>
                                    Order Now
                                </a>
                            </footer>
                ...
                <div class="row row-eq-height">
                        ...
                        <div class="product clearfix" id="product511">
                            <header>
                                <span id="product511-name">LIN VPS - SM 4 - 2025</span>
                                                            </header>
                            <div class="product-desc">
...
1 Dedicated IP<br />
                            ...
                            <footer>
                                <div class="product-pricing" id="product511-price">
                                                                                                                        Starting from
                                            <br />
                                                                                <span class="price">INR 2,305.00</span>
                                        <br />
                                                                                    Monthly
                                                                                <br>
                                                                                                            </div>
                                <a href="store_linux_self_managed_vps_hosting.aspx/lin-vps-sm-4-2025" class="btn btn-success btn-sm" id="product511-order-button">
                                    <i class="fas fa-shopping-cart"></i>
                                    Order Now
                                </a>
                            </footer>
                        ...
                        <div class="product clearfix" id="product510">
                            <header>
                                <span id="product510-name">LIN VPS - SM 3 - 2025</span>
                                                            </header>
                            <div class="product-desc">
...
1 Dedicated IP<br />
                            ...
                            <footer>
                                <div class="product-pricing" id="product510-price">
                                                                                                                        Starting from
                                            <br />
                                                                                <span class="price">INR 1,150.00</span>
                                        <br />
                                                                                    Monthly
                                                                                <br>
                                                                                                            </div>
                                <a href="store_linux_self_managed_vps_hosting.aspx/lin-vps-sm-3-2025" class="btn btn-success btn-sm" id="product510-order-button">
                                    <i class="fas fa-shopping-cart"></i>
                                    Order Now
                                </a>
                            </footer>
