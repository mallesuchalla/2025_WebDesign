<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="store_forex_vps_hosting.aspx.cs" Inherits="Ditsmart.store_forex_vps_hosting" %>
    ...
    <div class="row">
                ...
                <i class="fas fa-chevron-up card-minimise panel-minimise pull-right float-right"></i>
                    ...
                    <div class="list-group collapsable-card-body">
                            ...
                            Windows VPS Hosting
                                                                                ...
                                                                                <a menuItemName="Forex VPS Hosting" href="store_forex_vps_hosting.aspx" class="list-group-item list-group-item-action active" id="Secondary_Sidebar-Categories-Forex_VPS_Hosting">
        ...
        <div class="panel-heading card-header">
            <h3 class="panel-title">
                ...
                <form method="post" action="store_forex_vps_hosting.aspx">
        ...
        <form role="form">
            <select class="form-control custom-select" onchange="selectChangeNavigate(this)">
                        ...
                        Windows VPS Hosting
                                                        ...
                                                        <option menuItemName="Forex VPS Hosting" value="store_forex_vps_hosting.aspx" class="list-group-item" selected="selected">
                        Forex VPS Hosting
            ...
            <div class="products" id="products">
                <div class="row row-eq-height">
                        ...
                        <div class="product clearfix" id="product479">
                            <header>
                                <span id="product479-name">FOREX VPS 1 - 2024</span>
                                                            </header>
                            <div class="product-desc">
                                                                    <p id="product479-description">
                            ...
                            <footer>
                                <div class="product-pricing" id="product479-price">
                                                                                                                        Starting from
                                            <br />
                                                                                <span class="price">INR 1,100.00</span>
                                        <br />
                                                                                    Monthly
                                                                                <br>
                                                                                                            </div>
                                <a href="store_forex_vps_hosting.aspx/forex-vps-1-2024" class="btn btn-success btn-sm" id="product479-order-button">
                                    <i class="fas fa-shopping-cart"></i>
                                    Order Now
                                </a>
                            </footer>
                        ...
                        <div class="product clearfix" id="product480">
                            <header>
                                <span id="product480-name">FOREX VPS 2 - 2024</span>
                                                            </header>
                            <div class="product-desc">
                                                                    <p id="product480-description">
                                        4 Core	4 GB	80 GB<br />
                            ...
                            <footer>
                                <div class="product-pricing" id="product480-price">
                                                                                                                        Starting from
                                            <br />
                                                                                <span class="price">INR 1,750.00</span>
                                        <br />
                                                                                    Monthly
                                                                                <br>
                                                                                                            </div>
                                <a href="store_forex_vps_hosting.aspx/forex-vps-2-2024" class="btn btn-success btn-sm" id="product480-order-button">
                                    <i class="fas fa-shopping-cart"></i>
                                    Order Now
                                </a>
                            </footer>
                ...
                <div class="row row-eq-height">
                        ...
                        <div class="product clearfix" id="product481">
                            <header>
                                <span id="product481-name">FOREX VPS 3 - 2024</span>
                                                            </header>
                            <div class="product-desc">
                            ...
                            <footer>
                                <div class="product-pricing" id="product481-price">
                                                                                                                        Starting from
                                            <br />
                                                                                <span class="price">INR 2,600.00</span>
                                        <br />
                                                                                    Monthly
                                                                                <br>
                                                                                                            </div>
                                <a href="store_forex_vps_hosting.aspx/forex-vps-3-2024" class="btn btn-success btn-sm" id="product481-order-button">
                                    <i class="fas fa-shopping-cart"></i>
                                    Order Now
                                </a>
                            </footer>
                        ...
                        <div class="product clearfix" id="product482">
                            <header>
                                <span id="product482-name">FOREX VPS 4 - 2024</span>
                                                            </header>
                            <div class="product-desc">
                            ...
                            <footer>
                                <div class="product-pricing" id="product482-price">
                                                                                                                        Starting from
                                            <br />
                                                                                <span class="price">INR 3,450.00</span>
                                        <br />
                                                                                    Monthly
                                                                                <br>
                                                                                                            </div>
                                <a href="store_forex_vps_hosting.aspx/forex-vps-4-2024" class="btn btn-success btn-sm" id="product482-order-button">
                                    <i class="fas fa-shopping-cart"></i>
                                    Order Now
                                </a>
                            </footer>
