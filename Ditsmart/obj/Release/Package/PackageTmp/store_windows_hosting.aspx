<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="store_windows_hosting.aspx.cs" Inherits="Ditsmart.store_windows_hosting" %>
    ...
    <div class="row">
            ...
            <h3 class="panel-title">
                ...
                <i class="fas fa-chevron-up card-minimise panel-minimise pull-right float-right"></i>
                    ...
                    <div class="list-group collapsable-card-body">
                                                            <a menuItemName="Windows Hosting" href="store_windows_hosting.aspx" class="list-group-item list-group-item-action active" id="Secondary_Sidebar-Categories-Windows_Hosting">
        ...
        <div class="panel-heading card-header">
            <h3 class="panel-title">
                ...
                <form method="post" action="store_windows_hosting.aspx">
    ...
    <div class="panel-body card-body">
        <form role="form">
            <select class="form-control custom-select" onchange="selectChangeNavigate(this)">
                                                    <option menuItemName="Windows Hosting" value="store_windows_hosting.aspx" class="list-group-item" selected="selected">
                        Windows Hosting
            ...
            <div class="products" id="products">
                <div class="row row-eq-height">
                            ...
                            <div class="product clearfix" id="product1">
                                <header>
                                    <span id="product1-name">Windows Hosting Starter</span>
                                                                    </header>
                                ...
                                <footer>
                                    ...
                                    <a href="cart.php?a=add&pid=186" class="btn btn-success btn-sm" id="product1-order-button">
                            ...
                            <div class="product clearfix" id="product2">
                                <header>
                                    <span id="product2-name">Windows Hosting Performance</span>
                                                                    </header>
                                <div class="product-desc">
                                                                        <ul>
                                                                            </ul>
                                ...
                                <footer>
                                    <div class="product-pricing" id="product2-price">
                                                                                                                                <span class="price">INR 650.00</span>
                                            <br />
                                                                                            Monthly
                                                                                        <br>
                                                                                                                        </div>
                                    <a href="cart.php?a=add&pid=187" class="btn btn-success btn-sm" id="product2-order-button">
                                        <i class="fa fa-shopping-cart"></i>
                                        Order Now
                                    </a>
                                </footer>
                            ...
                            <div class="product clearfix" id="product3">
                                <header>
                                    <span id="product3-name">Windows Hosting Business</span>
                                                                    </header>
                                <div class="product-desc">
                                                                        <ul>
                                                                            </ul>
                                ...
                                <footer>
                                    <div class="product-pricing" id="product3-price">
                                                                                                                                <span class="price">INR 900.00</span>
                                            <br />
                                                                                            Monthly
                                                                                        <br>
                                                                                                                        </div>
                                    <a href="cart.php?a=add&pid=188" class="btn btn-success btn-sm" id="product3-order-button">
                                        <i class="fa fa-shopping-cart"></i>
                                        Order Now
                                    </a>
                                </footer>
