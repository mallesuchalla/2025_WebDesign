<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cart_domain_transfer_to_Us.aspx.cs" Inherits="Ditsmart.cart_domain_transfer_to_Us" %>
                ...
                <i class="fas fa-chevron-up card-minimise panel-minimise pull-right float-right"></i>
                    ...
                    <div class="list-group collapsable-card-body">
                            ...
                            Register a New Domain
                                                                                ...
                                                                                <a menuItemName="Domain Transfer" href="cart_domain_transfer_to_Us.aspx" class="list-group-item list-group-item-action active" id="Secondary_Sidebar-Actions-Domain_Transfer">
...
<input type="hidden" name="token" value="355c8b17c5ff5bc477697c7cd60dc1ba71093fd0" />
        ...
        <form role="form">
            <select class="form-control custom-select" onchange="selectChangeNavigate(this)">
                        ...
                        Register a New Domain
                                                        ...
                                                        <option menuItemName="Domain Transfer" value="cart_domain_transfer_to_Us.aspx" class="list-group-item" selected="selected">
                        Transfer in a Domain
    ...
    <div class="panel-body card-body">
        <form role="form">
            ...
            <form method="post" action="cart_domain_transfer_to_Us.aspx">
<input type="hidden" name="token" value="355c8b17c5ff5bc477697c7cd60dc1ba71093fd0" />
                            ...
                            <div class="panel-body card-body">
                                ...
                                <div id="transferUnavailable" class="alert alert-warning slim-alert text-center w-hidden"></div>
                                        ...
                                        <div class="default-captcha">
                                            ...
                                            <div>
                                                <img id="inputCaptchaImage" src="https://manage.hostitsmart.com/includes/verifyimage.php" />
