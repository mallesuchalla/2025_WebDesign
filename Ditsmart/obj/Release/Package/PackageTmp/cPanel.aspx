<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cPanel.aspx.cs" Inherits="Ditsmart.cPanel" %>
...
<!-- End Google Tag Manager -->
	...
	<title>cPanel - Host IT Smart Knowledge base</title>
	<meta name="description" content="Discover insightful articles on a wide range of topics in our cPanel category. Stay informed, and expand your knowledge with Host IT Smart." />
	<link rel="canonical" href="https://genbaseerp.com/manage/knowledgebase/5/cPanel" />
	<link rel="next" href="https://genbaseerp.com/manage/knowledgebase/5/cPanel/page/2" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="cPanel - Host IT Smart Knowledge base" />
	<meta property="og:description" content="Discover insightful articles on a wide range of topics in our cPanel category. Stay informed, and expand your knowledge with Host IT Smart." />
	<meta property="og:url" content="https://genbaseerp.com/manage/knowledgebase/5/cPanel" />
	<meta property="og:site_name" content="Host IT Smart Knowledge base" />
	<meta property="og:image" content="https://genbaseerp.com/manage/knowledgebase/wp-content/uploads/2024/09/cPanel.png" />
	<meta name="twitter:card" content="summary_large_image" />
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"CollectionPage","@id":"https://genbaseerp.com/manage/knowledgebase/5/cPanel","url":"https://genbaseerp.com/manage/knowledgebase/5/cPanel","name":"cPanel - Host IT Smart Knowledge base","isPartOf":{"@id":"https://genbaseerp.com/manage/knowledgebase/#website"},"description":"Discover insightful articles on a wide range of topics in our cPanel category. Stay informed, and expand your knowledge with Host IT Smart.","inLanguage":"en-US"},{"@type":"WebSite","@id":"https://genbaseerp.com/manage/knowledgebase/#website","url":"https://genbaseerp.com/manage/knowledgebase/","name":"Host IT Smart Knowledge base","description":"","publisher":{"@id":"https://genbaseerp.com/manage/knowledgebase/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"https://genbaseerp.com/manage/knowledgebase/?s={search_term_string}"},"query-input":{"@type":"PropertyValueSpecification","valueRequired":true,"valueName":"search_term_string"}}],"inLanguage":"en-US"},{"@type":"Organization","@id":"https://genbaseerp.com/manage/knowledgebase/#organization","name":"Host IT Smart Knowledge base","url":"https://genbaseerp.com/manage/knowledgebase/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"https://genbaseerp.com/manage/knowledgebase/#/schema/logo/image/","url":"","contentUrl":"","width":240,"height":80,"caption":"Host IT Smart Knowledge base"},"image":{"@id":"https://genbaseerp.com/manage/knowledgebase/#/schema/logo/image/"}}]}</script>
	<!-- / Yoast SEO plugin. -->
...
<link rel="alternate" type="application/rss+xml" title="Host IT Smart Knowledge base &raquo; cPanel Category Feed" href="https://genbaseerp.com/manage/knowledgebase/5/cPanel/feed" />
...
<link rel="https://api.w.org/" href="https://genbaseerp.com/manage/knowledgebase/wp-json/" /><link rel="alternate" title="JSON" type="application/json" href="https://genbaseerp.com/manage/knowledgebase/wp-json/wp/v2/categories/1" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="https://genbaseerp.com/manage/knowledgebase/xmlrpc.php?rsd" />
...
<script src="https://code.jquery.com/jquery-3.2.1.slim.min.js" integrity="sha384-KJ3o2DKtIkvYIK3UENzmM7KCkRr/rE9/Qpg6aAZGJwFDMVNA/GpGFF93hXpG5KkN" crossorigin="anonymous"></script>
	...
	<body class="archive category category-cpanel category-1 wp-embed-responsive">
...
<span class="tittle_heading">Knowledgebase</span>
            <!-- <h1 style="display: none;">Knowledgebase</h1> -->
                ...
                <ul class="breadcrumb"><li><a href="https://genbaseerp.com/manage/knowledgebase/"> Knowledgebase </a></li><li class="breadcrumb-separator">/&nbsp;</li><li><a href="https://genbaseerp.com/manage/knowledgebase/5/cPanel">cPanel</a></li></ul>            </div>
                     <header>
      <form method="get" class="search-form" action="https://genbaseerp.com/manage/knowledgebase/">
          <div class="kb_ctg_inpt_answer">
                <div class="input-group mb-3">
                  <input type="search" class="form-control" placeholder="Enter a question here to search our knowledgebase for answers..." aria-label="Recipient's username" aria-describedby="button-addon2" name="s" action="https://genbaseerp.com/manage/knowledgebase/">
      ...
      <div class="kb_ctg_heading">  <h1>Category: <span>cPanel</span></h1></div>      <div class="col-sm-4">
    <a href="https://genbaseerp.com/manage/knowledgebase/18/Cpanel-sql"><i class="fa-solid fa-folder-closed"></i> Cpanel sql&nbsp;<span class="badge badge-info">6</span></a><p></p></div>

    </header>

          <div class="kb_rltd_pst_heading">
                <h3>Articles</h3>
              </div>
    <div id="load-more-container">
        <!-- This container will hold additional posts loaded via AJAX -->
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var category = 'cpanel'; // Get current category slug
    var postsPerPage = 10; // Number of posts to load per scroll
    var loading = false; // Flag to prevent multiple AJAX requests
    var footer = document.getElementById('colophon'); // Get the footer element
    ...
    function loadMorePosts() {
        if (!loading) {
            ...
            xhr.open('GET', 'https://genbaseerp.com/manage/knowledgebase/wp-admin/admin-ajax.php?action=load_more_posts&category=' + category + '&page=' + page + '&posts_per_page=' + postsPerPage);
            xhr.onload = function() {
                if (xhr.status === 200) {
                    var response = xhr.responseText;
                    var container = document.getElementById('load-more-container');
                    container.insertAdjacentHTML('beforeend', response);
                    page++; // Increment page counter for next load
                    loading = false;

                    // Check if the loaded content leaves the footer still visible
                    if (response.trim() !== '' && isFooterVisible()) {
                        loadMorePosts(); // Load more posts if footer is still visible
                    }

                    if (response.trim() === '') {
                        window.removeEventListener('scroll', scrollListener); // Remove scroll listener if no more posts
                    }
                } else {
...
Served from: www.hostitsmart.com @ 2025-03-01 11:48:17 by W3 Total Cache
-->
