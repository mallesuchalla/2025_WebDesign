<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="aws_support_services.aspx.cs" Inherits="Ditsmart.aws_support_services" %>
...
<title>AWS Support Services Provider - Business Plans &amp; Pricing</title>

<meta name="description" content="Host IT Smart offers reliable AWS Premium, Cloud, Customer, Business, Technical, Enterprise, Managed support services in India at an affordable price.">
<link rel="canonical" href="https://genbaseerp.com/aws-support-services" />
<link rel="alternate" href="https://genbaseerp.com/aws-support-services" hreflang="en-in" />
 
<link rel="alternate" hreflang="x-default" href="global.aspxaws-support-services" />  
<link rel="alternate" href="global.aspxaws-support-services" hreflang="en-us" />
<meta name="author" content="">
<meta property="og:url" content="https://genbaseerp.com/aws-support-services" />
<meta property="og:type" content="website" />
<meta property="og:title" content="AWS Support Services Provider - Business Plans &amp; Pricing" />
<meta property="og:description" content="Host IT Smart offers reliable AWS Premium, Cloud, Customer, Business, Technical, Enterprise, Managed support services in India at an affordable price." />
<meta property="og:image" content="Images/logo.png" />
<meta name="twitter:card" content="Host IT Smart offers reliable AWS Premium, Cloud, Customer, Business, Technical, Enterprise, Managed support services in India at an affordable price." />
<meta name="twitter:title" content="AWS Support Services Provider - Business Plans &amp; Pricing" />
<meta name="twitter:url" content="https://genbaseerp.com/aws-support-services" />
<meta name="twitter:description" content="Host IT Smart offers reliable AWS Premium, Cloud, Customer, Business, Technical, Enterprise, Managed support services in India at an affordable price." />
...
<!-- <link rel="stylesheet" href="https://d1neo0gtmjcot5.cloudfront.net/assets/theme_v1/main_theme_v1.css?v=202502190207" media="all" /> -->
<link rel="stylesheet" href="https://genbaseerp.com/assets/css/custom.css?v=202502190207" media="all" />
<link rel="stylesheet" href="/assets/css/common.css?v=202502190207" media="all" />


<link rel="stylesheet" href="https://d1neo0gtmjcot5.cloudfront.net/assets/css/domain-landing.css?v=202502190207" media="all" />
...
<link rel="stylesheet" href="https://genbaseerp.com/assets/css/new-header23.css?v=202502190207" media="all" />
<link rel="stylesheet" href="https://genbaseerp.com/assets/css/aws-support.css?v=202502190207" media="all" />
...
<div class="banner-inner aws-banner" style="background-image:url(https://genbaseerp.com/assets/images/aws_banner_bg.jpg)">
    <div class="container">
        ...
        <div class="aws-managed-services head-tb-p-40">
            ...
            <div class="col-sm-4 col-12">
                <div class="right aos-init" data-aos="fade-right" data-aos-delay="600">
                    <img src="https://genbaseerp.com/assets/images/aws-support.png" alt="AWS Services" />
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="features-main">
                <div class="section-heading">
                    <h2 class="text_head text-center">Host IT Smart Helps You in Following Ways:</h2>
                </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-5 col-12 right-start aos-init" data-aos="fade-left" data-aos-delay="800">
                <div class="right">
                    <div class="right-in">
                        <h2>Partner with Host IT Smart to make AWS work for you!</h2>
                        <div class="work">
                            <ul>
                                <li>
                                    <img title="Big Bang" alt="Big Bang Host IT Smart AWS Work" src="https://genbaseerp.com/assets/images/partner1.png">
                                </li>
                                <li>
                                    <img title="COSMONAUT" alt="COSMONAUT Host IT Smart AWS Work" src="https://genbaseerp.com/assets/images/partner2.png">
                                </li>
                            </ul>
                        </div>
                    </div>
...
<div class="modal fade common-popup" id="all-offer" role="dialog" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
                ...
                <div class="common-body">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <form method="POST" action="https://genbaseerp.com/aws-support-services" accept-charset="UTF-8" class="custom-input form-group contact_form" autocomplete="off" name="aws_form" id="aws_form"><input name="_token" type="hidden" value="EHRRPkGgW4JzPRZcZDT8jCb0J9bcMAF5YS6b2BBN">
                            <input name="varRefURL" type="hidden" value="https://genbaseerp.com/aws-support-services">
                            ...
                            <div class="form-group">
                                ...
                                <input maxlength="40" id="var_Fname" pattern="[a-zA-Z\s]+" autocomplete="off" class="form-control" placeholder="Enter your first name" name="var_Fname" type="text">
                                                            </div>
                            <div class="form-group">
                                <label for="comname">Last Name <span class="required">*</span></label>
                                <input maxlength="40" id="var_Lname" pattern="[a-zA-Z\s]+" autocomplete="off" class="form-control" placeholder="Enter your last name" name="var_Lname" type="text">
                                                            </div>
                            <div class="form-group">
                                <label for="comemail">EMAIL <span class="required">*</span></label>
                                <input maxlength="50" id="var_email" autocomplete="off" class="form-control" placeholder="Enter your email address" name="var_email" type="text">
                                                            </div>
                            <div class="form-group">
                                <label for="comphone">Phone <span class="required">*</span></label>
                                <input maxlength="20" id="var_phone" autocomplete="off" class="form-control" placeholder="Enter your phone #" onpaste="return false;" ondrop="return false;" onkeypress="javascript: return KeycheckOnlyPhonenumber(event);" name="var_phone" type="tel">
                                                            </div>
                            <div class="form-group">
                                <label for="comphone">Company</label>
                                <input maxlength="80" id="var_company" pattern="[a-zA-Z\s]+" autocomplete="off" class="form-control" placeholder="Enter your company" name="var_company" type="text">
                            </div>
                            <div class="form-group">
                                <label for="comphone">State</label>
                                <input maxlength="50" id="var_state" pattern="[a-zA-Z\s]+" autocomplete="off" class="form-control" placeholder="Enter your state/region" name="var_state" type="text">
                            </div>
                            
                            <div class="form-group">
                                <label for="commessage">Message <span class="required">*</span></label>
                                <textarea maxlength="1000" class="form-control" autocomplete="off" placeholder="Enter your message here..." cols="40" rows="3" id="var_message" spellcheck="true" name="var_message"></textarea>
                                                            </div>
                            ...
                            <div class="col-12">
                                <div class="form-group text-center">
                                    By clicking "Submit", you agree to our <a target="_blank" title="Privacy Policy" href="https://genbaseerp.com/privacy-policy">Privacy Policy</a>.
                                </div>
                            </div>
        ...
        <script src="https://genbaseerp.com/assets/js/aws-support.js?v=202502190207"></script>
    </div>
</div>
<script type="text/javascript">
...
<div id="browsernote" style="display:none;position:fixed;width:100%;height:100%;background:rgba(0,0,0,0.8);z-index:9999;top:0;left:0;font-size:18px;">
    <div style="font-size:18px;color:#fff;background:#18b35c;padding:15px;text-align:center;height:60px;z-index:9999;position:fixed;width:100%;top:0;margin:auto;">For a better experience on <strong style="color:#000;">Host IT Smart,</strong><a href="https://support.apple.com/downloads" style="cursor:pointer;color: #ffffff;font-size:14px;margin-left:10px;display:inline-block;" target="_blank">update your browser.</a>
        ...
        <!-- Main Wrapper E -->
                <!-- <script src="https://d1neo0gtmjcot5.cloudfront.net/assets/theme_v1/main_theme_v1.js?v=202502190207"></script> -->
...
<script src="assets/js/common_v12.js?v=202502190207" type="text/javascript" ></script>
...
document.addEventListener("DOMContentLoaded",function(){let e=document.querySelectorAll(".accordion-toggle");e.forEach(t=>{t.addEventListener("click",function(){if(window.innerWidth<=992){e.forEach(e=>{e!==t&&(e.classList.remove("active"),e.nextElementSibling.style.display="none")}),this.classList.toggle("active");let i=this.nextElementSibling;"block"===i.style.display?i.style.display="none":i.style.display="block"}})}),window.addEventListener("resize",function(){window.innerWidth>992&&e.forEach(e=>{e.classList.remove("active");let t=e.nextElementSibling;t.style.display=""})})});
    ...
    <!-- footer-menu-for-mobile-view-e -->            
            ...
            <script src="https://genbaseerp.com/assets/js/custom.js?v=202502190207"></script>
...
<script>
    ...
    const globalRequestParamOne = 'aws-support-services';
