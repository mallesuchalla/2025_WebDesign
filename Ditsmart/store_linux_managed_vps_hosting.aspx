<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="store_linux_managed_vps_hosting.aspx.cs" Inherits="Ditsmart.store_linux_managed_vps_hosting" %>
    ...
    <div class="row">
                    ...
                    <div class="list-group collapsable-card-body">
                            ...
                            WordPress Hosting
                             ...
                             Linux Self-Managed VPS Hosting 
                                                                                ...
                                                                                <a menuItemName="Linux Managed VPS Hosting" href="store_linux_managed_vps_hosting.aspx" class="list-group-item list-group-item-action active" id="Secondary_Sidebar-Categories-Linux_Managed_VPS_Hosting">
        ...
        <div class="panel-heading card-header">
            <h3 class="panel-title">
                ...
                <form method="post" action="store_linux_managed_vps_hosting.aspx">
            ...
            <select class="form-control custom-select" onchange="selectChangeNavigate(this)">
                        ...
                        WordPress Hosting
                         ...
                         Linux Self-Managed VPS Hosting 
                                                        ...
                                                        <option menuItemName="Linux Managed VPS Hosting" value="store_linux_managed_vps_hosting.aspx" class="list-group-item" selected="selected">
                        Linux Managed VPS Hosting
            ...
            <div class="products" id="products">
                <div class="row row-eq-height">
                        ...
                        <div class="product clearfix" id="product471">
                            <header>
                                <span id="product471-name">LIN VPS - M 1 - 2024</span>
                                                            </header>
                            <div class="product-desc">
                                                                    <p id="product471-description">
                                        2 Core	2 GB	40 GB<br />
                            ...
                            <footer>
                                <div class="product-pricing" id="product471-price">
                                                                                                                        Starting from
                                            <br />
                                                                                <span class="price">INR 3,440.00</span>
                                        <br />
                                                                                    Monthly
                                                                                <br>
                                                                                                            </div>
                                <a href="store_linux_managed_vps_hosting.aspx/lin-vps-m-1-2024" class="btn btn-success btn-sm" id="product471-order-button">
                                    <i class="fas fa-shopping-cart"></i>
                                    Order Now
                                </a>
                            </footer>
                        ...
                        <div class="product clearfix" id="product472">
                            <header>
                                <span id="product472-name">LIN VPS - M 2 - 2024</span>
                                                            </header>
                            <div class="product-desc">
                                                                    <p id="product472-description">
                                        2 Core	4 GB	60 GB<br />
                            ...
                            <footer>
                                <div class="product-pricing" id="product472-price">
                                                                                                                        Starting from
                                            <br />
                                                                                <span class="price">INR 3,790.00</span>
                                        <br />
                                                                                    Monthly
                                                                                <br>
                                                                                                            </div>
                                <a href="store_linux_managed_vps_hosting.aspx/lin-vps-m-2-2024" class="btn btn-success btn-sm" id="product472-order-button">
                                    <i class="fas fa-shopping-cart"></i>
                                    Order Now
                                </a>
                            </footer>
                ...
                <div class="row row-eq-height">
                        ...
                        <div class="product clearfix" id="product516">
                            <header>
                                <span id="product516-name">LIN VPS - M 1 - 2025</span>
                                                            </header>
                            <div class="product-desc">
...
1 Dedicated IP<br />
                            ...
                            <footer>
                                <div class="product-pricing" id="product516-price">
                                                                                                                        Starting from
                                            <br />
                                                                                <span class="price">INR 3,640.00</span>
                                        <br />
                                                                                    Monthly
                                                                                <br>
                                                                                                            </div>
                                <a href="store_linux_managed_vps_hosting.aspx/lin-vps-m-1-2025" class="btn btn-success btn-sm" id="product516-order-button">
                                    <i class="fas fa-shopping-cart"></i>
                                    Order Now
                                </a>
                            </footer>
                        ...
                        <div class="product clearfix" id="product473">
                            <header>
                                <span id="product473-name">LIN VPS - M 3 - 2024</span>
                                                            </header>
                            <div class="product-desc">
                                                                <ul>
                                                                    </ul>
                            ...
                            <footer>
                                <div class="product-pricing" id="product473-price">
                                                                                                                        Starting from
                                            <br />
                                                                                <span class="price">INR 4,090.00</span>
                                        <br />
                                                                                    Monthly
                                                                                <br>
                                                                                                            </div>
                                <a href="store_linux_managed_vps_hosting.aspx/lin-vps-m-3-2024" class="btn btn-success btn-sm" id="product473-order-button">
                                    <i class="fas fa-shopping-cart"></i>
                                    Order Now
                                </a>
                            </footer>
                ...
                <div class="row row-eq-height">
                        ...
                        <div class="product clearfix" id="product474">
                            <header>
                                <span id="product474-name">LIN VPS - M 4 - 2024</span>
                                                            </header>
                            <div class="product-desc">
                                                                <ul>
                                                                    </ul>
                            ...
                            <footer>
                                <div class="product-pricing" id="product474-price">
                                                                                                                        Starting from
                                            <br />
                                                                                <span class="price">INR 4,490.00</span>
                                        <br />
                                                                                    Monthly
                                                                                <br>
                                                                                                            </div>
                                <a href="store_linux_managed_vps_hosting.aspx/lin-vps-m-4-2024" class="btn btn-success btn-sm" id="product474-order-button">
                                    <i class="fas fa-shopping-cart"></i>
                                    Order Now
                                </a>
                            </footer>
                        ...
                        <div class="product clearfix" id="product475">
                            <header>
                                <span id="product475-name">LIN VPS - M 5 - 2024</span>
                                                            </header>
                            <div class="product-desc">
                                                                    <p id="product475-description">
                                        6 Core	8 GB	120 GB<br />
                            ...
                            <footer>
                                <div class="product-pricing" id="product475-price">
                                                                                                                        Starting from
                                            <br />
                                                                                <span class="price">INR 4,940.00</span>
                                        <br />
                                                                                    Monthly
                                                                                <br>
                                                                                                            </div>
                                <a href="store_linux_managed_vps_hosting.aspx/lin-vps-m-5-2024" class="btn btn-success btn-sm" id="product475-order-button">
                                    <i class="fas fa-shopping-cart"></i>
                                    Order Now
                                </a>
                            </footer>
                ...
                <div class="row row-eq-height">
                        ...
                        <div class="product clearfix" id="product476">
                            <header>
                                <span id="product476-name">LIN VPS - M 6 - 2024</span>
                                                            </header>
                            <div class="product-desc">
                                                                    <p id="product476-description">
                                        6 Core	12 GB	160 GB<br />
                            ...
                            <footer>
                                <div class="product-pricing" id="product476-price">
                                                                                                                        Starting from
                                            <br />
                                                                                <span class="price">INR 5,440.00</span>
                                        <br />
                                                                                    Monthly
                                                                                <br>
                                                                                                            </div>
                                <a href="store_linux_managed_vps_hosting.aspx/lin-vps-m-6-2024" class="btn btn-success btn-sm" id="product476-order-button">
                                    <i class="fas fa-shopping-cart"></i>
                                    Order Now
                                </a>
                            </footer>
                        ...
                        <div class="product clearfix" id="product477">
                            <header>
                                <span id="product477-name">LIN VPS - M 7 - 2024</span>
                                                            </header>
                            <div class="product-desc">
                                                                    <p id="product477-description">
                                        8 Core	12 GB	200 GB<br />
                            ...
                            <footer>
                                <div class="product-pricing" id="product477-price">
                                                                                                                        Starting from
                                            <br />
                                                                                <span class="price">INR 5,790.00</span>
                                        <br />
                                                                                    Monthly
                                                                                <br>
                                                                                                            </div>
                                <a href="store_linux_managed_vps_hosting.aspx/lin-vps-m-7-2024" class="btn btn-success btn-sm" id="product477-order-button">
                                    <i class="fas fa-shopping-cart"></i>
                                    Order Now
                                </a>
                            </footer>
                ...
                <div class="row row-eq-height">
                        ...
                        <div class="product clearfix" id="product478">
                            <header>
                                <span id="product478-name">LIN VPS - M 8 - 2024</span>
                                                            </header>
                            <div class="product-desc">
                                                                    <p id="product478-description">
                                        8 Core	16 GB	250 GB<br />
                            ...
                            <footer>
                                <div class="product-pricing" id="product478-price">
                                                                                                                        Starting from
                                            <br />
                                                                                <span class="price">INR 6,440.00</span>
                                        <br />
                                                                                    Monthly
                                                                                <br>
                                                                                                            </div>
                                <a href="store_linux_managed_vps_hosting.aspx/lin-vps-m-8-2024" class="btn btn-success btn-sm" id="product478-order-button">
                                    <i class="fas fa-shopping-cart"></i>
                                    Order Now
                                </a>
                            </footer>
                        ...
                        <div class="product clearfix" id="product518">
                            <header>
                                <span id="product518-name">LIN VPS - M 2 - 2025</span>
                                                            </header>
                            <div class="product-desc">
...
8 TB bandwidth<br />
                            ...
                            <footer>
                                <div class="product-pricing" id="product518-price">
                                                                                                                        Starting from
                                            <br />
                                                                                <span class="price">INR 3,828.00</span>
                                        <br />
                                                                                    Monthly
                                                                                <br>
                                                                                                            </div>
                                <a href="store_linux_managed_vps_hosting.aspx/lin-vps-m-2-2025" class="btn btn-success btn-sm" id="product518-order-button">
                                    <i class="fas fa-shopping-cart"></i>
                                    Order Now
                                </a>
                            </footer>
                ...
                <div class="row row-eq-height">
                                                                                    <div class="col-md-6">
                        <div class="product clearfix" id="product520">
                            <header>
                                <span id="product520-name">LIN VPS - M 4 - 2025</span>
                                                            </header>
                            <div class="product-desc">
                                                                    <p id="product520-description">
                                        8 vCPU cores<br />
32 GB RAM<br />
400 GB SSD<br />
32 TB Bandwidth<br />
1 Dedicated IP<br />
                            ...
                            <footer>
                                <div class="product-pricing" id="product520-price">
                                                                                                                        Starting from
                                            <br />
                                                                                <span class="price">INR 6,155.00</span>
                                        <br />
                                                                                    Monthly
                                                                                <br>
                                                                                                            </div>
                                <a href="store_linux_managed_vps_hosting.aspx/lin-vps-m-4-2025" class="btn btn-success btn-sm" id="product520-order-button">
                                    <i class="fas fa-shopping-cart"></i>
                                    Order Now
                                </a>
                            </footer>
                        ...
                        <div class="product clearfix" id="product519">
                            <header>
                                <span id="product519-name">LIN VPS - M 3 - 2025</span>
                                                            </header>
                            <div class="product-desc">
...
1 Dedicated IP<br />
                            ...
                            <footer>
                                <div class="product-pricing" id="product519-price">
                                                                                                                        Starting from
                                            <br />
                                                                                <span class="price">INR 4,580.00</span>
                                        <br />
                                                                                    Monthly
                                                                                <br>
                                                                                                            </div>
                                <a href="store_linux_managed_vps_hosting.aspx/lin-vps-m-3-2025" class="btn btn-success btn-sm" id="product519-order-button">
                                    <i class="fas fa-shopping-cart"></i>
                                    Order Now
                                </a>
                            </footer>
