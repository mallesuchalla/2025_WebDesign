...
<head>
    ...
    <link rel="canonical" href="https://genbaseerp.com" />
    <link rel="alternate" href="https://genbaseerp.com" hreflang="en-in" />

    <link rel="alternate" hreflang="x-default" href="global.aspx" />
    <link rel="alternate" href="global.aspx" hreflang="en-us" />
    <meta name="author" content="">
    <meta property="og:url" content="https://genbaseerp.com" />
    ...
    <meta name="twitter:url" content="https://genbaseerp.com" />
    ...
    <%-- <link href="Home_Styles/all.min.css" rel="stylesheet" />--%>
    ...
    <!-- <link rel="stylesheet" href="https://d1neo0gtmjcot5.cloudfront.net/assets/theme_v1/home_theme_v1.css?v=202502190603" media="all" /> -->
    <link rel="preload" as="image" href="Images/black-friday-bnnr2.png">
    <link rel="preload" as="image" href="Images/black-friday-BG.png">
    <link rel="stylesheet" href="Styles/custom.css" media="all" />
    <link rel="stylesheet" href="Styles/common.css" media="all" />

    <link rel="stylesheet" href="Home_Styles/domain-landing.css" media="all" />
    ...
    <link href="Home_Styles/hostadvice-award.css" rel="stylesheet" />




    <link rel="stylesheet" href="Home_Styles/new-header23.css" media="all" />
    <link rel="stylesheet" href="Home_Styles/homepage.css" />
    <link href="Styles/bootstrap.min.css" rel="stylesheet">
    <script src="JS/popper.min.js"></script>
    <script src="JS/bootstrap.min.js"></script>
            ...
            <div class="mega-menu-fixed fixed-header" id="myHeader">
                        ...
                        <div class="hdr-tp-rgt hdr_tp_cmn">
                            <ul>
                                <li class="nav-item dropdown hdr_top_cntc_us">
                                    <a title="Contact Us" class="nav-link" href="#" role="button" data-toggle="dropdown" aria-expanded="false">Contact Us <i class="fa-solid fa-angle-down"></i>
                                    </a>
                                ...
                                <li class="nav-item dropdown hdr_top_cntc_us">
                                    <a title="Account" class="nav-link" href="#" role="button" data-toggle="dropdown" aria-expanded="false">Register/Login <i class="fa-solid fa-angle-down"></i>
                                    </a>
                                    <div class="dropdown-menu">
                                ...
                                <li class="nav-item dropdown hdr_top_ctry_list">
                                    ...
                                    <div class="dropdown-menu">
                                        <a title="Canada" class="dropdown-item" href="canada.aspx">
                                            <img src="Images/canada_flag.png" alt="canada_flag_icon" loading="lazy">
                                            <p>Canada</p>
                                        </a>
                                        <a title="Global" class="dropdown-item" href="global.aspx">
                                            <img src="Images/global_icon.png" alt="global_icon" loading="lazy">
                                            <p>Global</p>
                                        </a>
                                    </div>
                                </li>
                ...
                <div class="main_navbar_megamenu">
                    <nav class="navbar navbar-expand-lg navbar-light rounded megamenu-navbar" id="navbar-nav">
                        <a class="navbar-brand navbar-megamenu-logo" href="https://genbaseerp.com" title="Host IT Smart">
                            <img style="max-height: 70px;" src="Images/logo.png" alt="logo" loading="lazy"></a>
                                        ...
                                        <ul class="mega-box-clm">
                                            <li class="hdr_tp_menu_li">
                                                <a class="dropdown-item" href="domain_registration.aspx" title="Domain Registration">
                                                    <div class="mega-menu-icon">
                                                        <img src="Images/dmn-register.png" alt="Domain Registration" loading="lazy">
                                                    </div>
                                            ...
                                            <li class="hdr_tp_menu_li">
                                                <a class="dropdown-item" href="domain_transfer.aspx" title="Domain Transfer">
                                                    <div class="mega-menu-icon">
                                                        <img src="Images/transfer-icon.png" alt="Domain Transfer" loading="lazy">
                                                    </div>
                                                    <div class="mega-menu-cont">
                                            ...
                                            <li class="hdr_tp_menu_li">
                                                <a class="dropdown-item" href="bulk_domain_search.aspx" title="Bulk Domain Search">
                                                    <div class="mega-menu-icon">
                                                        <img src="Images/search-icon.png" alt="Bulk Domain Search" loading="lazy">
                                                    </div>
                                                    <div class="mega-menu-cont">
                                            ...
                                            <li class="hdr_tp_menu_li">
                                                <a class="dropdown-item" href="whois.aspx" title="Whois Checker">
                                                    <div class="mega-menu-icon">
                                                        <img src="Images/check-icon.png" alt="Whois Checker" loading="lazy">
                                                    </div>
                                                    <div class="mega-menu-cont">
                                        ...
                                        <ul class="mega-box-clm">
                                            <li class="hdr_tp_menu_li">
                                                <a class="dropdown-item" href="web_hosting.aspx" title="Web Hosting ">
                                                    <div class="mega-menu-icon">
                                                        <img src="Images/web-hosting-icon.png" alt="web-hosting-icon" loading="lazy">
                                                    </div>
                                                    <div class="mega-menu-cont">
                                            ...
                                            <li class="hdr_tp_menu_li">
                                                <a class="dropdown-item" href="linux_hosting.aspx" title="Linux Hosting">
                                                    <div class="mega-menu-icon">
                                                        <img src="Images/linux-hosting.png" alt="Linux Hosting" loading="lazy">
                                                    </div>
                                                    <div class="mega-menu-cont">
                                            ...
                                            <li class="hdr_tp_menu_li">
                                                <a class="dropdown-item" href="windows_hosting.aspx" title="Windows Hosting">
                                                    <div class="mega-menu-icon">
                                                        <img src="Images/windows-hosting.png" alt="Windows Hosting" loading="lazy">
                                                    </div>
                                                    <div class="mega-menu-cont">
                                            ...
                                            <li class="hdr_tp_menu_li">
                                                <a class="dropdown-item" href="wordpress_hosting.aspx" title="Wordpress Hosting">
                                                    <div class="mega-menu-icon">
                                                        <img src="Images/wordpress-hosting.png" alt="WordPress Hosting" loading="lazy">
                                                    </div>
                                                    <div class="mega-menu-cont">
                                            ...
                                            <li class="hdr_tp_menu_li">
                                                <a class="dropdown-item" href="ecommerce_hosting.aspx" title="Ecommerce Hosting">
                                                    <div class="mega-menu-icon">
                                                        <img src="Images/ecommerce-hosting.png" alt="eCommerce Hosting" loading="lazy">
                                                    </div>
                                                    <div class="mega-menu-cont">
                                            ...
                                            <li class="hdr_tp_menu_li">
                                                <a class="dropdown-item" href="deals#Web_Hosting.aspx" title="Hosting Deals">
                                                    <div class="mega-menu-icon">
                                                        <img src="Images/deals-icon.png" alt="Hosting Deals" loading="lazy">
                                                    </div>
                                                    <div class="mega-menu-cont">
                                        ...
                                        <ul class="mega-box-clm">
                                            ...
                                            <li class="hdr_tp_menu_li">
                                                <a class="dropdown-item" href="vps_hosting.aspx" title="VPS Hosting">
                                                    <div class="mega-menu-icon">
                                                        <img src="Images/linux-hosting.png" alt="Linux VPS Hosting" loading="lazy">
                                                    </div>
                                                    <div class="mega-menu-cont">
                                            ...
                                            <li class="hdr_tp_menu_li">
                                                <a class="dropdown-item" href="managed_vps_hosting.aspx" title="Manage VPS Hosting">
                                                    <div class="mega-menu-icon">
                                                        <img src="Images/linux-hosting.png" alt="Manage VPS Hosting" loading="lazy">
                                                    </div>
                                                    <div class="mega-menu-cont">
                                            ...
                                            <li class="hdr_tp_menu_li">
                                                <a class="dropdown-item" href="windows_vps_hosting.aspx" title="Windows VPS Hosting">
                                                    <div class="mega-menu-icon">
                                                        <img src="Images/windows-hosting.png" alt="Windows VPS Hosting" loading="lazy">
                                                    </div>
                                                    <div class="mega-menu-cont">
                                            ...
                                            <li class="hdr_tp_menu_li">
                                                <a class="dropdown-item" href="forex_vps_hosting.aspx" title="Fores VPS Hosting">
                                                    <div class="mega-menu-icon">
                                                        <img src="Images/forex-vps.png" alt="Forex VPS Hosting" loading="lazy">
                                                    </div>
                                                    <div class="mega-menu-cont">
                                            ...
                                            <li class="hdr_tp_menu_li">
                                                <a class="dropdown-item" href="dedicated_servers.aspx" title="Dedicated Server Hosting">
                                                    <div class="mega-menu-icon">
                                                        <img src="Images/dedicated-server.png" alt="Dedicated Server Hosting" loading="lazy">
                                                    </div>
                                                    <div class="mega-menu-cont">
                                            ...
                                            <li class="hdr_tp_menu_li">
                                                <a class="dropdown-item" href="deals#SERVERS.aspx" title="Server Deals">
                                                    <div class="mega-menu-icon">
                                                        <img src="Images/deals-icon.png" alt="Deals Icon" loading="lazy">
                                                    </div>
                                                    <div class="mega-menu-cont">
                                        ...
                                        <ul class="mega-box-clm">
                                            <li class="hdr_tp_menu_li">
                                                <a class="dropdown-item" href="google_workspace_india.aspx" title="Google Workspace">
                                                    <div class="mega-menu-icon">
                                                        <img src="Images/google-icon.png" alt="Google Workspace" loading="lazy">
                                                    </div>
                                                    <div class="mega-menu-cont">
                                            ...
                                            <li class="hdr_tp_menu_li">
                                                <a class="dropdown-item" href="microsoft_office_365_suite.aspx" title="Microsoft 365">
                                                    <div class="mega-menu-icon">
                                                        <img src="Images/microsoft365-icon.png" alt="Microsoft 365" loading="lazy">
                                                    </div>
                                                    <div class="mega-menu-cont">
                ...
                <div>
                    ...
                    <div class="  -home-banner">
                        ...
                        <div>
                            ...
                            <link rel="stylesheet" href="Home_Styles/diwali-23-banner.css">



                            <div class="home_page_wbh_bnnr">
                                <div>
                                    <div class="row d-flex align-items-center">
                                        <div class="col-lg-6 d-flex align-items-center">
                                            <div class="bnnr-wbh-left bnnr-wbh-cstm">
                                                <h1>Web Hosting India</h1>

                                                <h2>Trusted Partner For Robust, <span class="space_br">Reliable &amp; Affordable Hosting</span></h2>

                                                <p>Experience fully optimized servers, lightning-fast speed, world-class security and 24X7 human support with Host IT Smart&#39;s amazing hosting packages.</p>
                                                <a class="btn-started" href="#services_section_plan">GET STARTED</a> <a class="chat-box-btn" href="javascript:void(Tawk_API.toggle())" id="chat-btn-home" title="Chat With Us">Chat With Us</a>
                                            </div>
                                        </div>

                                        <div class="col-lg-6">
                                            <div class="bnnr-wbh-right bnnr-wbh-cstm">
                                                <img width="800" height="600" alt="Hero-Banner-img" class="img-fluid" loading="eager" src="Images/Hero-Banner-img.png" />
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="hm-bnnr-cstmr-rtg">
                                                <div class="cstmr-rtg-main cst-rtg-hostadvice">
                                                    <div class="cst-rtg-tittle">
                                                        <img alt="hostadvice" loading="lazy" src="Images/hostadvice-logo.png" />
                                                    </div>

                                                    <div class="cst-rtg-star">
                                                        <img alt="star-icon" loading="lazy" src="Images/star-icon.png" />
                                                        <img alt="star-icon" loading="lazy" src="Images/star-icon.png" />
                                                        <img alt="star-icon" loading="lazy" src="Images/star-icon.png" />
                                                        <img alt="star-icon" loading="lazy" src="Images/star-icon.png" />
                                                    </div>
                                                ...
                                                <div class="cstmr-rtg-main cst-rtg-trustpilot">
                                                    <div class="cst-rtg-tittle">
                                                        <img alt="trustpilot" loading="lazy" src="Images/trustpilot-logo.png" />
                                                    </div>
                                                ...
                                                <div class="cstmr-rtg-main cst-rtg-google">
                                                    <div class="cst-rtg-tittle">
                                                        <img alt="google" loading="lazy" src="Images/google-logo.png" />
                                                    </div>
                                    ...
                                    <div class="row justify-content-center align-items-center">
                                        <div class="col-sm-12">
                                            ...
                                            <form class="domain-search-form" id="domainlookupfrm" onsubmit="margetlds()" autocomplete="off" name="domainlookupfrm" action="domain_checker.aspx" method="post" novalidate="novalidate">
                                                ...
                                                <div class="">
                                                    <button type="submit" class="btn btn-brand-01 dsf-button" style="border-radius: 30px">
                                            ...
                                            <div class="domain-list-wrap text-center mt-4">
                                                <ul class="list-inline domain-search-list">
                                                    <li class="list-inline-item">
                                                        ...
                                                        <a href="buy_com_domain_names.aspx" title="Com">
                                                            <img src="Images/dotcom.png" alt=".Com" title="buy Com domain names" width="60" class="img-fluid" height="14">
                                            ...
                                            949
                                                    ...
                                                    <li class="list-inline-item">
                                                        ...
                                                        <a href="buy_info_domain_names.aspx" title="Info">
                                                            <img src="Images/dotinfo.png" alt=".Info" title="buy Info domain names" width="56" class="img-fluid" height="20">
                                                            <span class="text-cstm-clr">&#8377;
                                            1220.43
                                                            </span>
                                                        </a>
                                                    ...
                                                    <li class="list-inline-item">
                                                        ...
                                                        <a href="buy_org_domain_names.aspx" title="Org">
                                                            <img src="Images/dotorg.png" alt=".Org" title="buy Org domain names" width="49" class="img-fluid" height="20">
                                                            <span class="text-cstm-clr">&#8377;
                                            1066.79
                                                            </span>
                                                        </a>
                                                    ...
                                                    <li class="list-inline-item">
                                                        ...
                                                        <a href="buy_in_domain_names.aspx" title="In">
                                                            <img src="Images/dotin.png" alt=".In" title="buy In domain names" width="44" class="img-fluid" height="25">
                                                            <span class="text-cstm-clr">&#8377;
                                            899
                                                            </span>
                                                        </a>
                            ...
                            <div class="row">
                                    ...
                                    <div class="box" data-aos="fade-down" data-aos-delay="600">
                                        <div class="popular-price  pricing-new-wrapper ">
                                            <div class="pricing-icon text-center">
                                                <img src="Images/shared_hosting.png" alt="shared_hosting" width="48" height="55">
                                            </div>
                                            <div class="text-center">
                                                <a class="package-title text-center" href="linux_hosting.aspx">
                                                    <div class="package-title-fw text-center"><span>LINUX </span>HOSTING </div>
                                                </a>
                                            </div>
                                            <div class="package-title-pw">Offers great performance features with PHP and MySQL compatibility </div>
                                            ...
                                            <div class="pricing-price pt-4">
                                                ...
                                                <div class="home-page-plans-cutprice line-through">
                                                    <span class="small">₹225</span><span class="price-cycle">/mo</span>
                                                    <br>
                                                </div>
                                                <div class="h2">
                                                    &#8377;45<span class="price-cycle h4">/mo</span>
                                                </div>
                                        ...
                                        <a href='linux_hosting.aspx' class="btn_bottom" id="linux_hosting" title="Get Started Now"><span class="btn_p"></span>Get Started Now</a>




                                        <!--Button For Mobile-->
                                        <a href="linux_hosting.aspx" class="btn_bottom_for_mbl" title="Get Started Now">Get Started Now</a>
                                        <!--End-->
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="box" data-aos="fade-down" data-aos-delay="300">
                                        <div class="popular-price  pricing-new-wrapper ">
                                            <div class="pricing-icon text-center">
                                                <img src="Images/wordpress.png" alt="wordpress" width="55" height="55">
                                            </div>
                                            <div class="text-center">
                                                <a class="package-title text-center" href="wordpress_hosting.aspx">
                                                    <div class="package-title-fw text-center"><span>WORDPRESS </span>HOSTING </div>
                                                </a>
                                            </div>
                                            <div class="package-title-pw">Optimized hosting with amazing features for WordPress websites</div>
                                        ...
                                        <a href='wordpress_hosting.aspx' class="btn_bottom" id="wordpress_hosting" title="Get Started Now"><span class="btn_p"></span>Get Started Now</a>




                                        <!--Button For Mobile-->
                                        <a href="wordpress_hosting.aspx" class="btn_bottom_for_mbl" title="Get Started Now">Get Started Now</a>
                                        <!--End-->
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="box" data-aos="fade-down" data-aos-delay="100">
                                        <div class="popular-price  pricing-new-wrapper ">
                                            <div class="pricing-icon text-center">
                                                <img src="Images/window.png" alt="window" width="54" height="54">
                                            </div>
                                            <div class="text-center">
                                                <a class="package-title text-center" href="windows_hosting.aspx">
                                                    <div class="package-title-fw text-center"><span>WINDOWS </span>HOSTING </div>
                                                </a>
                                            </div>
                                            <div class="package-title-pw">Quality Microsoft Hosting for those that want MS SQL, ASP.NET, or .NET</div>
                                            ...
                                            <div class="pricing-price pt-4">
                                                ...
                                                <div class="h2">
                                                    &#8377;90<span class="price-cycle h4">/mo</span>
                                                </div>
                                        ...
                                        <a href='windows_hosting.aspx' class="btn_bottom" id="windows_hosting" title="Get Started Now"><span class="btn_p"></span>Get Started Now</a>




                                        <!--Button For Mobile-->
                                        <a href="windows_hosting.aspx" class="btn_bottom_for_mbl" title="Get Started Now">Get Started Now</a>
                                        <!--End-->
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="box" data-aos="fade-down" data-aos-delay="100">
                                        <div class="popular-price  pricing-new-wrapper ">
                                            <div class="pricing-icon text-center">
                                                <img src="Images/vps.png" alt="vps" width="48" height="57">
                                            </div>
                                            <div class="text-center">
                                                <a class="package-title text-center" href="vps_hosting.aspx">
                                                    <div class="package-title-fw text-center"><span>VPS </span>Hosting </div>
                                                </a>
                                            </div>
                                            <div class="package-title-pw">Great Server Performance at Affordable Costs</div>
                                            ...
                                            <div class="pricing-price pt-4">
                                                <small>Starting at</small>
                                                <div class="home-page-plans-cutprice line-through">
                                                    <span class="small">₹720</span><span class="price-cycle">/mo</span>
                                                    <br>
                                                </div>
                                                <div class="h2">
                                                    &#8377;420<span class="price-cycle h4">/mo</span>
                                                </div>
                                        ...
                                        <a href='vps_hosting.aspx' class="btn_bottom" id="vps_hosting" title="Get Started Now"><span class="btn_p"></span>Get Started Now</a>




                                        <!--Button For Mobile-->
                                        <a href="vps_hosting.aspx" class="btn_bottom_for_mbl" title="Get Started Now">Get Started Now</a>
                                        <!--End-->
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="box" data-aos="fade-down" data-aos-delay="300">
                                        <div class="popular-price  pricing-new-wrapper ">
                                            <div class="pricing-icon text-center">
                                                <img src="Images/window_vps.png" alt="window_vps" width="66" height="57">
                                            </div>
                                            <div class="text-center">
                                                <a class="package-title text-center" href="windows_vps_hosting.aspx">
                                                    <div class="package-title-fw text-center">
                                                        <span>Windows </span>VPS     Hosting
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="package-title-pw">Benefit of Power & Flexibility at the best costs</div>
                                            ...
                                            <div class="pricing-price pt-4">
                                                <small>Starting at</small>
                                                <div class="home-page-plans-cutprice line-through">
                                                    <span class="small">₹1300</span><span class="price-cycle">/mo</span>
                                                    <br>
                                                </div>
                                                <div class="h2">
                                                    &#8377;825<span class="price-cycle h4">/mo</span>
                                                </div>
                                        ...
                                        <a href='windows_vps_hosting.aspx' class="btn_bottom" id="windows_vps_hosting" title="Get Started Now"><span class="btn_p"></span>Get Started Now</a>




                                        <!--Button For Mobile-->
                                        <a href="windows_vps_hosting.aspx" class="btn_bottom_for_mbl" title="Get Started Now">Get Started Now</a>
                                        <!--End-->
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="box" data-aos="fade-down" data-aos-delay="600">
                                        <div class="popular-price  pricing-new-wrapper ">
                                            <div class="pricing-icon text-center">
                                                <img src="Images/dedicated_server.png" alt="dedicated_server" width="58" height="57">
                                            </div>
                                            <div class="text-center">
                                                <a class="package-title text-center" href="dedicated_servers.aspx">
                                                    <div class="package-title-fw text-center"><span>Dedicated </span>Servers </div>
                                                </a>
                                            </div>
                                            <div class="package-title-pw">With great Server Autonomy comes great performance!</div>
                                            <p class="small mb-2">High Performance</p>
                                            ...
                                            <div class="pricing-price pt-4">
                                                <small>Starting at</small>
                                                <div class="home-page-plans-cutprice line-through">
                                                    <span class="small">₹4218</span><span class="price-cycle">/mo</span>
                                                    <br>
                                                </div>
                                                <div class="h2">
                                                    &#8377;3585<span class="price-cycle h4">/mo</span>
                                                </div>
                                        ...
                                        <a href='dedicated_servers.aspx' class="btn_bottom" id="dedicated_servers" title="Get Started Now"><span class="btn_p"></span>Get Started Now</a>




                                        <!--Button For Mobile-->
                                        <a href="dedicated_servers.aspx" class="btn_bottom_for_mbl" title="Get Started Now">Get Started Now</a>
                                        <!--End-->
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="feature-section ptb-60">
                        <div class="container">
                            ...
                            <div class="row align-items-center justify-content-between">
                                <div class="col-md-5 col-lg-6 d-none d-md-block d-lg-block">
                                    <div class="feature-img-wrap text-center">
                                        <img src="Images/Quality_hardware.png" class="img-fluid" loading="lazy" alt="High-Quality Hardware">
                                    </div>
                                </div>
                            ...
                            <div class="row align-items-center justify-content-between mt-5">
                                ...
                                <div class="col-md-5 col-lg-6 d-none d-md-block d-lg-block">
                                    <div class="feature-img-wrap text-center">
                                        <img src="Images/Robust_hosting.png" class="img-fluid" loading="lazy" alt="Robust Systems for Hosting">
                                    </div>
                                </div>
                            </div>
                            <div class="row align-items-center justify-content-between mt-5">
                                <div class="col-md-5 col-lg-6 d-none d-md-block d-lg-block">
                                    <div class="feature-img-wrap text-center">
                                        <img src="Images/Experience_lightning.png" class="img-fluid" loading="lazy" alt="Fast Connectivity & Low Latency">
                                    </div>
                                </div>
                                <div class="col-md-7 col-lg-6">
                                    <div class="hstng-content-wrap">
                                ...
                                <div class="row justify-content-center pb-20">
                                    <div class="col-md-12">
                                        <div class="section-heading text-center my-4">
                                            <h2 class="text_head_lgt">Easily Manage your Domain and Hosting
                                                <br>
                                                All in one place!</h2>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-lg-6 wmdts-res p-4 domain-transfer">
                                            <div class="cta-content-wrap">
                                                <div class="mig-tra-image">
                                                    <img loading="lazy" src="Images/domain_transfer.png" alt="domain_transfer">
                                                </div>
                                            ...
                                            <div class="action-btns mt-4">
                                                <a href="domain_transfer.aspx" class="btn btn-brand-03" title="Get Started Now">Get Started Now</a>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 wmdts-res p-4">
                                            <div class="cta-content-wrap">
                                                <div class="mig-tra-image">
                                                    <img loading="lazy" src="Images/website_migration.png" alt="website_migration">
                                                </div>
                                            ...
                                            <div class="action-btns mt-4">
                                                <a href="web_hosting.aspx" class="btn btn-brand-03" title="Get Started Now">Get Started Now</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <div class="card-body">
                                                    <div class="pb-2">
                                                        <span class="top-faeture ">
                                                            <img loading="lazy" src="Images/features-1.png" alt="Promising Performance">
                                                        </span>
                                                    </div>
                                                    <div class="pt-2 pb-3">
                                        ...
                                        <div class="col-md-6 col-lg-4 cstmd-flex">
                                            <div class="card single-promo-card single-promo-hover p-2 mt-4">
                                                <div class="card-body">
                                                    <div class="pb-2">
                                                        <span class="top-faeture">
                                                            <img loading="lazy" src="Images/features-2.png" alt="Flexible Options">
                                                        </span>
                                                    </div>
                                                    <div class="pt-2 pb-3">
                                        ...
                                        <div class="col-md-6 col-lg-4 cstmd-flex">
                                            <div class="card single-promo-card single-promo-hover p-2 mt-4">
                                                <div class="card-body">
                                                    <div class="pb-2">
                                                        <span class="top-faeture  ">
                                                            <img loading="lazy" src="Images/features-3.png" alt="Incredibly Inexpensive">
                                                        </span>
                                                    </div>
                                                    <div class="pt-2 pb-3">
                                        ...
                                        <div class="col-md-6 col-lg-4 cstmd-flex">
                                            <div class="card single-promo-card single-promo-hover p-2 mt-4">
                                                <div class="card-body">
                                                    <div class="pb-2">
                                                        <span class="top-faeture  ">
                                                            <img loading="lazy" src="Images/features-4.png" alt="Strong Security">
                                                        </span>
                                                    </div>
                                                    <div class="pt-2 pb-3">
                                        ...
                                        <div class="col-md-6 col-lg-4 cstmd-flex">
                                            <div class="card single-promo-card single-promo-hover p-2 mt-4">
                                                <div class="card-body">
                                                    <div class="pb-2">
                                                        <span class="top-faeture ">
                                                            <img loading="lazy" src="Images/features-5.png" alt="Quality Assurance">
                                                        </span>
                                                    </div>
                                                    <div class="pt-2 pb-3">
                                        ...
                                        <div class="col-md-6 col-lg-4 cstmd-flex">
                                            <div class="card single-promo-card single-promo-hover p-2 mt-4">
                                                <div class="card-body">
                                                    <div class="pb-2">
                                                        <span class="top-faeture  ">
                                                            <img loading="lazy" src="Images/features-6.png" alt="Everpresent Support">
                                                        </span>
                                                    </div>
                                                    <div class="pt-2 pb-3">
                            ...
                            <div class="row align-items-center justify-content-between">
                                <div class="col-md-6 col-lg-5 d-none d-lg-block">
                                    <div class="ctact-img-wrap text-center">
                                        <img loading="lazy" src="Images/Support_img.png" class="img-fluid" alt="server room">
                                    </div>
                                </div>
                                <div class="col-12 col-lg-6">
                                    ...
                                    <div class="support-action d-inline-flex flex-wrap">
                                        <a id="email_contact_home_page" href="mailto:info@hostitsmart.com" title="info@hostitsmart.com" class="mr-3"><i class="fas fa-comment mr-1 color-accent"></i><span>info@hostitsmart.com</span></a>
                                        <a id="phone_number_home_page" href="tel:079-3507-9700" class="mb-0"><i class="fas fa-phone-alt mr-1 color-accent"></i><span>079-3507-9700</span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        <div class="cust-del-owl-carousel">
                                            <div class="owl-carousel cust-delight-owl-carousel">
                                                ...
                                                <div class="item cust-del-item">
                                                    <p>
                                                        We have been using Host IT Smart for almost more than 3 years now, and we must say, it is best, cheapest & most supportive hosting provider!
                                    They are flexible, reachable & technical sound team who is always keen to support us technically!
                                    Special thanks to Vineesh & Jessil sir, for the continuous support & excellent relation-building!
                                                    </p>
                                                    <span>LearnTEZ</span>
                                                </div>
                                                <div class="item cust-del-item">
                                                    <p>
                                                        One of the best and cheap hosting in India, I have been using their services for the last 5 years and have never faced any problem. If you need a hosting solution, HOSTITSMART is the best in their services. Their support team is awesome. They will help in going far better in their fields, and all are very supportive.

                                    Thanks, Host IT Smart Team. You guys rock!
                                                    </p>
...
<div id="carouselExampleControlsNoTouching" class="carousel slide" data-bs-touch="false">
	...
	<div class="container"> 
		<div class="row d-flex justify-content-center" >
			...
			<div class="item col">
				<a rel="nofollow" href="https://www.google.com/search?num=100&rlz=1C1AVNE_enIN715IN715&ei=2YkXXMeSJ5T_wAOB6ZX4AQ&q=host+it+smart&oq=host+it+smart&gs_l=psy-ab.3..0l3j0i22i30l7.1080.3046..3688...0.0..0.238.2460.0j9j4......0....1..gws-wiz.......0i71j0i131j0i67j0i10j0i131i67.oxHhcjMtoSY#lrd=0x395e84d7c974bd5f:0x91cf8c25003fbd01,1,," title="GOOGLE GSUITE PARTNER" target="_blank"><img rel="dns-prefetch" src="assets/images/Homepage/partners_googlegsuite.png" alt="Google Gsuite Partner"/></a>
			</div>
			<div class="item col">
				<a rel="nofollow" href="http://www.cpanel.net/partners/partner-info.cgi?cid=3101" title="CPANEL PARTNER" target="_blank"><img rel="dns-prefetch" src="assets/images/Homepage/partners_cpanel.png" alt="Cpanel Partner"/></a>
			</div>
			<div class="item col">
				<a rel="nofollow" href="http://centos-webpanel.com/noc-partner-list" title="CWP PARTNER" target="_blank"><img rel="dns-prefetch" src="assets/images/Homepage/partners_cwp.png" alt="CWP Partner"/></a>	
			</div>
			<!-- <div class="item col">
				<a href="#" title="MICROSOFT PARTNER" target="_blank"><img rel="dns-prefetch" src="assets/images/Homepage/partners_microsoft.png" alt="MICROSOFT PARTNER"/></a>
			</div> -->
                    <!-- <div class="item col">
				<a rel="nofollow" href="https://www.icann.org/search/#!/?searchText=Netclues" title="ICANN" target="_blank"><img rel="dns-prefetch" src="assets/images/Homepage/partners_icann.png" alt="icann"/></a>
			</div> -->
                    <!--<div class="item col">-->
                    <!--	<a rel="nofollow" href="https://hosting.review/hosting-provider/hostitsmart" title="HOSTING REVIEW" target="_blank"><img rel="dns-prefetch" src="assets/images/Homepage/hosting-review.png" alt="Hosting.review"/></a>-->
                    <!--</div>-->
                    <!-- <div class="item col">
				<a rel="nofollow" href="https://www.trustpilot.com/review/www.hostitsmart.com" title="TRUSTPILOT" target="_blank"><img rel="dns-prefetch" src="assets/images/Homepage/partners_trustpilot.png" alt="trustpilot"/></a>
			</div>
			<div class="item col">
				<a rel="nofollow" href="https://aws.amazon.com/partners/find/results/?keyword=Netclues" title="AMAZON PARTNER" target="_blank"><img rel="dns-prefetch" src="assets/images/Homepage/partners_amazonwebservice.png" alt="AMAZON PARTNER"/></a>
			</div>
			<div class="item col">
				<a rel="nofollow" href="https://fixthephoto.com/host-it-smart-review.html" title="fixthephoto" target="_blank"><img rel="dns-prefetch" src="assets/images/Homepage/fixthephoto-min.png" alt="fixthephoto"/></a>
			</div>
		</div>
		</div>
	</div>
                                ...
                                <div class="col-md-12">
                                    <div class="owl-carousel owl-carousel-associated_with owl-theme clients-carousel dot-indicator">
                                        <div class="item single-customer">
                                            <img loading="lazy" src="Images/partners_cpanel_v2.png" alt="Cpanel Partner" class="customer-logo">
                                        </div>
                                        <div class="item single-customer">
                                            <img loading="lazy" src="Images/partners_cwp_v2.png" alt="CWP Partner" class="customer-logo">
                                        </div>
                                        <div class="item single-customer">
                                            <img loading="lazy" src="Images/partners_icann_v2.png" alt="icann" class="customer-logo">
                                        </div>
                                        <div class="item single-customer">
                                            <img loading="lazy" src="Images/Domain-Brothers_v2.png" alt="Domain-Brothers" class="customer-logo">
                                        </div>
                                        <div class="item single-customer">
                                            <img loading="lazy" src="Images/partners_amazonwebservice.png" alt="AMAZON PARTNER" class="customer-logo">
                                        </div>
                                        <div class="item single-customer">
                                            <img loading="lazy" src="Images/partners_googlegsuite.png" alt="Google G-Suite" class="customer-logo">
                                        </div>
                                        <div class="item single-customer">
                                            <!-- <img src="https://d1neo0gtmjcot5.cloudfront.net/assets/images/partners_plesk.png" alt="plesk" class="customer-logo"> -->
                                            <img loading="lazy" src="Images/partners_plesk.png" alt="plesk" class="customer-logo">
                                        </div>
                                        <div class="item single-customer">
                                            <!-- <img src="https://d1neo0gtmjcot5.cloudfront.net/assets/images/partners_plesk.png" alt="plesk" class="customer-logo"> -->
                                            <img loading="lazy" src="Images/partners_softaculous.png" alt="softaculous" class="customer-logo">
                                        </div>
                                        <div class="item single-customer">
                                            <!-- <img src="https://d1neo0gtmjcot5.cloudfront.net/assets/images/partners_plesk.png" alt="plesk" class="customer-logo"> -->
                                            <img loading="lazy" src="Images/partners_webuzo.png" alt="webuzo" class="customer-logo">
                                        </div>
                                        <div class="item single-customer">
                                            <!-- <img src="https://d1neo0gtmjcot5.cloudfront.net/assets/images/partners_plesk.png" alt="plesk" class="customer-logo"> -->
                                            <img loading="lazy" src="Images/partners_acronis.png" alt="acronis" class="customer-logo">
                                        </div>
                                        <div class="item single-customer">
                                            <!-- <img src="https://d1neo0gtmjcot5.cloudfront.net/assets/images/partners_plesk.png" alt="plesk" class="customer-logo"> -->
                                            <img loading="lazy" src="Images/partner_microsoft_SPLA.png" alt="partner_microsoft_SPLA" class="customer-logo">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <section class="gray-light-bg head-tb-p-40">
                                        ...
                                        <div class="col-md-12 col-lg-12">
                                            ...
                                            <div class="accordion-item mb-3 faqs-card" style="">
                                                ...
                                                <div id="collapse2" class="collapse" data-parent="#accordion" style="">
                                                    <div class="card-body white-bg">
                                                        ...
                                                        <p>
                                                            Our long-standing presence in the industry reflects our commitment to quality service and customer satisfaction!
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="accordion-item mb-3 faqs-card" style="">
                                                ...
                                                <div id="collapse4" class="collapse" data-parent="#accordion" style="">
                                                    <div class="card-body white-bg">
                                                        <p>Host IT Smart's servers are strategically located worldwide to cater to diverse hosting needs. For Shared hosting, servers are in India, Canada, and Germany. VPS servers are hosted in India, while<b><a href="dedicated_servers.aspx" style="color: #18b35c;">&nbsp;Dedicated servers </a></b>are housed in the USA, ensuring robust performance and reliability across our offerings.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item mb-3 faqs-card" style="">
                                            ...
                                            <div class="accordion-item mb-3 faqs-card" style="">
                                                ...
                                                <div id="collapse21" class="collapse" data-parent="#accordion" style="">
                                                    <div class="card-body white-bg">
                                                        <p>To view and manage your billing information, please log in to our <b><a href="clientarea.aspx" style="color: #18b35c;">Client Area</a></b>. From there, you can conveniently access and update all your billing details.</p>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-lg-6 col-sm-7">
                                        <div class="encrg-offers-cnt">
                                            ...
                                            <form id="ic_signupform" method="POST" action="https://app.icontact.com/icp/core/mycontacts/signup/designer/form/?id=176&cid=487250&lid=59438" captcha-key="6LeCZCcUAAAAALhxcQ5fN80W6Wa2K3GqRQK6WRjA" captcha-theme="light" new-captcha="true">
                                                ...
                                                <!-- Span for email error messages -->
                                                <div class="g-recaptcha" data-sitekey="6LeCZCcUAAAAALhxcQ5fN80W6Wa2K3GqRQK6WRjA" id="subs-g-recaptcha"></div>
                                                <span id="captcha-message" style="color: red;"></span>
                                                <!-- Span for CAPTCHA error messages -->
                                                ...
                                                <span id="checkbox-message" style="color: red;"></span>
                                                <!-- Span for checkbox error messages -->
                                            </form>
        ...
        <div class="container">
            <div class="row">
                                            ...
                                            <div class="login-signup-wrap bg-white rounded shadow">
                                                ...
                                                <form class="login-box-form" id="signup-form" action="https://genbaseerp.com/front-register" method="post" role="form" style="display: block;">
                                                    ...
                                                    <div class="form-group mb-4 name-form-grp ">
                                                        <!-- Label -->
                                                        <label class="pb-3">CLIENT NAME <span class="required">*</span></label>
                                                        <!-- Input group -->
                                                        <div class="input-group input-group-merge">
                                                            <input type="text" name="firstname" id="txtclientname" tabindex="1" class="form-control" placeholder="Client name" value="" required="required" autocomplete="off" pattern="[a-zA-Z\s'']+" title="Please enter valid input">
                                                        </div>
                                                    </div>


                                                    <div class="form-group mb-4 name-form-grp ">
                                                        <label class="pb-3">ADDRESS1 <span class="required">*</span></label>
                                                        <!-- Input group -->
                                                        <div class="input-group input-group-merge">
                                                            <input type="text" name="lastname" id="txtaddressline1" tabindex="1" class="form-control" placeholder="Address Line1" value="" required="required" autocomplete="off" pattern="[a-zA-Z\s'']+" title="Please enter valid input">
                                                        </div>
                                                    </div>
                                                    <div class="form-group mb-4 name-form-grp ">
                                                        <label class="pb-3">ADDRESS2 <span class="required">*</span></label>
                                                        <!-- Input group -->
                                                        <div class="input-group input-group-merge">
                                                            <input type="text" name="lastname" id="txtaddressline2" tabindex="1" class="form-control" placeholder="Address Line2" value="" required="required" autocomplete="off" pattern="[a-zA-Z\s'']+" title="Please enter valid input">
                                                        </div>
                                                    </div>
                                                    <div class="form-group mb-4 name-form-grp ">
                                                        <label class="pb-3">ADDRESS3 <span class="required">*</span></label>
                                                        <!-- Input group -->
                                                        <div class="input-group input-group-merge">
                                                            <input type="text" name="lastname" id="txtaddressline3" tabindex="1" class="form-control" placeholder="Address Line3" value="" required="required" autocomplete="off" pattern="[a-zA-Z\s'']+" title="Please enter valid input">
                                                        </div>
                                                    </div>
                                                    <div class="form-group mb-4 name-form-grp ">
                                                        <label class="pb-3">CITY <span class="required">*</span></label>
                                                        <!-- Input group -->
                                                        <div class="input-group input-group-merge">
                                                            <input type="text" name="lastname" id="txtcity" tabindex="1" class="form-control" placeholder="City name" value="" required="required" autocomplete="off" pattern="[a-zA-Z\s'']+" title="Please enter valid input">
                                                        </div>
                                                    </div>
                                                    <div class="form-group mb-4 name-form-grp ">
                                                        <label class="pb-3">CONTACT PERSON <span class="required">*</span></label>
                                                        <!-- Input group -->
                                                        <div class="input-group input-group-merge">
                                                            <input type="text" name="lastname" id="txtcperson" tabindex="1" class="form-control" placeholder="Contact Person Name" value="" required="required" autocomplete="off" pattern="[a-zA-Z\s'']+" title="Please enter valid input">
                                                        </div>
                                                    </div>
                                                    <div class="form-group mb-4 name-form-grp ">
                                                        <label class="pb-3">Mobile Number <span class="required">*</span></label>
                                                        <div class="input-group input-group-merge">
                                                            <input type="tel" name="phone_number" id="txtmobileno" value="" tabindex="1" class="form-control" placeholder="Phone Number" value="" required="required" pattern="^(?!(?:\D*0)+\D*$)\(?([0-9]{3})\)?[-. ]?[0-9]{3}[-. ]?[0-9]{4}$" autocomplete="off">
                                                        </div>
                                                    </div>
                                                    <div class="form-group mb-4 name-form-grp ">
                                                        <label class="pb-3">Land Line Number <span class="required">*</span></label>
                                                        <div class="input-group input-group-merge">
                                                            <input type="tel" name="phone_number" id="txtlandlineno" value="" tabindex="1" class="form-control" placeholder="Land Line Number" value="" required="required" pattern="^(?!(?:\D*0)+\D*$)\(?([0-9]{3})\)?[-. ]?[0-9]{3}[-. ]?[0-9]{4}$" autocomplete="off">
                                                        </div>
                                                    </div>
                                                    <div class="form-group mb-4 name-form-grp ">
                                                        <label class="pb-3">REGISTER BY<span class="required">*</span></label>
                                                        <div class="input-group input-group-merge">
                                                            <select class=" form-control" data-live-search="true" id="ddlcreatedby">
                                                            ...
                                                            <div class="col-lg-4 col-4">
                                                                <div class="code-row">
                                                                    <div class="form-group mb-4 ">
                                                                        ...
                                                                        <div class="input-group input-group-merge">
                                                                            <select class=" form-control" data-live-search="true" id="ddlcountry" name="otpcountry">
                                                    ...
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <div class="input-group input-group-merge">
                                                            ...
                                                            <input type="text" name="email" id="txtemail" tabindex="2" class="form-control" placeholder="Email ID" value="" required="required" autocomplete="off">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group login-box-terms mt-4">
                                                        ...
                                                        <label for="check-terms">I want to receive personalized offers, updates & information about Host IT Smart's products & services. <span class="required">* </span></label>
                                                        <br>
                                                    </div>
                ...
                <div id="browsernote" style="display: none; position: fixed; width: 100%; height: 100%; background: rgba(0,0,0,0.8); z-index: 9999; top: 0; left: 0; font-size: 18px;">
                    <div style="font-size: 18px; color: #fff; background: #18b35c; padding: 15px; text-align: center; height: 60px; z-index: 9999; position: fixed; width: 100%; top: 0; margin: auto;">
                        For a better experience on <strong style="color: #000;">Host IT Smart,</strong><a href="https://support.apple.com/downloads" style="cursor: pointer; color: #ffffff; font-size: 14px; margin-left: 10px; display: inline-block;" target="_blank">update your browser.</a>
                    </div>
                </div>

                <!-- Main Wrapper E -->
                <!-- <script src="https://d1neo0gtmjcot5.cloudfront.net/assets/theme_v1/main_theme_v1.js?v=202502190603"></script> -->
...
// var myInput=document.getElementById("password1"),letter=document.getElementById("letter"),capital=document.getElementById("capital"),number=document.getElementById("number"),length=document.getElementById("length"),specCharacter=document.getElementById("specCharacter");myInput.onfocus=function(){document.getElementById("validation_div").style.display="block"},myInput.onblur=function(){document.getElementById("validation_div").style.display="none"},myInput.onkeyup=function(){myInput.value.match(/[a-z]/g)?(letter.classList.remove("invalid"),letter.classList.add("valid")):(letter.classList.remove("valid"),letter.classList.add("invalid")),myInput.value.match(/[A-Z]/g)?(capital.classList.remove("invalid"),capital.classList.add("valid")):(capital.classList.remove("valid"),capital.classList.add("invalid")),myInput.value.match(/[0-9]/g)?(number.classList.remove("invalid"),number.classList.add("valid")):(number.classList.remove("valid"),number.classList.add("invalid")),myInput.value.length>=6?(length.classList.remove("invalid"),length.classList.add("valid")):(length.classList.remove("valid"),length.classList.add("invalid")),myInput.value.match(/[!@#$%^&*$]/g)?(specCharacter.classList.remove("invalid"),specCharacter.classList.add("valid")):(specCharacter.classList.remove("valid"),specCharacter.classList.add("invalid"))};
            ...
            <script>
                ...
                let base64Output = '';  // Variable to hold the base64 encoded image data

                // This function will be triggered when the DOM is fully loaded
                document.addEventListener("DOMContentLoaded", function () {
                    ...
                    fileInput.addEventListener('change', function (event) {
                        ...
                        if (file) {
                            ...
                            reader.onload = function (e) {
                                // Store the Base64 encoded image data in the global variable
                                base64Output = e.target.result;
                            };
                ...
                function getRegData() {
                    ...
                    var formData = {
                        ...
                        CreatedDate: new Date().toISOString(), // FIXED: Use a valid date format
                        IpAddress: '',
                    ...
                    $.ajax({
                        type: "POST",
                        url: "Home.aspx/InsertRegistrationData",
