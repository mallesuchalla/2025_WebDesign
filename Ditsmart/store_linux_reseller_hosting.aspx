<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="store_linux_reseller_hosting.aspx.cs" Inherits="Ditsmart.store_linux_reseller_hosting" %>
    ...
    <div class="row">
                ...
                <i class="fas fa-chevron-up card-minimise panel-minimise pull-right float-right"></i>
                    ...
                    <div class="list-group collapsable-card-body">
                            ...
                            Linux Hosting
                                                                                ...
                                                                                <a menuItemName="Linux Reseller Hosting" href="store_linux_reseller_hosting.aspx" class="list-group-item list-group-item-action active" id="Secondary_Sidebar-Categories-Linux_Reseller_Hosting">
        ...
        <div class="panel-heading card-header">
            <h3 class="panel-title">
                ...
                <form method="post" action="store_linux_reseller_hosting.aspx">
        ...
        <form role="form">
            <select class="form-control custom-select" onchange="selectChangeNavigate(this)">
                        ...
                        Linux Hosting
                                                        ...
                                                        <option menuItemName="Linux Reseller Hosting" value="store_linux_reseller_hosting.aspx" class="list-group-item" selected="selected">
                        Linux Reseller Hosting
            ...
            <div class="products" id="products">
                <div class="row row-eq-height">
                        ...
                        <div class="product clearfix" id="product176">
                            <header>
                                <span id="product176-name">Linux Reseller Starter</span>
                                                            </header>
                            ...
                            <footer>
                                ...
                                <a href="store_linux_reseller_hosting.aspx/linux-reseller-starter" class="btn btn-success btn-sm" id="product176-order-button">
                                    <i class="fas fa-shopping-cart"></i>
                                    Order Now
                                </a>
                            </footer>
                        ...
                        <div class="product clearfix" id="product177">
                            <header>
                                <span id="product177-name">Linux Reseller Performance</span>
                                                            </header>
                            <div class="product-desc">
                                                                <ul>
                                                                    </ul>
                            ...
                            <footer>
                                <div class="product-pricing" id="product177-price">
                                                                                                                    <span class="price">INR 3,300.00</span>
                                        <br />
                                                                                    Monthly
                                                                                <br>
                                                                                                            </div>
                                <a href="store_linux_reseller_hosting.aspx/linux-reseller-performance" class="btn btn-success btn-sm" id="product177-order-button">
                                    <i class="fas fa-shopping-cart"></i>
                                    Order Now
                                </a>
                            </footer>
                ...
                <div class="row row-eq-height">
                        ...
                        <div class="product clearfix" id="product178">
                            <header>
                                <span id="product178-name">Linux Reseller Business</span>
                                                            </header>
                            <div class="product-desc">
                                                                <ul>
                                                                    </ul>
                            ...
                            <footer>
                                ...
                                <a href="store_linux_reseller_hosting.aspx/linux-reseller-business" class="btn btn-success btn-sm" id="product178-order-button">
                                    <i class="fas fa-shopping-cart"></i>
                                    Order Now
                                </a>
                            </footer>
