<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="buy_com_domain_names.aspx.cs" Inherits="Ditsmart.buy_com_domain_names" %>
<!DOCTYPE html>
<html lang="en-in">
...
<title>.com Domain Registration | Buy Your .com Domain Name</title>

<meta name="description" content="Buy .com domain names. Buy one of the most popular domain extensions on the Internet with domain theft protection and 24/7 local support.">
<link rel="canonical" href="buy_com_domain_names.aspx" />
<link rel="alternate" href="buy_com_domain_names.aspx" hreflang="en-in" />
 
<link rel="alternate" hreflang="x-default" href="global.aspxdomain/buy-com-domain-names" />  
<link rel="alternate" href="global.aspxdomain/buy-com-domain-names" hreflang="en-us" />
<meta name="author" content="">
<meta property="og:url" content="buy_com_domain_names.aspx" />
<meta property="og:type" content="website" />
<meta property="og:title" content=".com Domain Registration | Buy Your .com Domain Name" />
<meta property="og:description" content="Buy .com domain names. Buy one of the most popular domain extensions on the Internet with domain theft protection and 24/7 local support." />
<meta property="og:image" content="Images/logo.png" />
<meta name="twitter:card" content="Buy .com domain names. Buy one of the most popular domain extensions on the Internet with domain theft protection and 24/7 local support." />
<meta name="twitter:title" content=".com Domain Registration | Buy Your .com Domain Name" />
<meta name="twitter:url" content="buy_com_domain_names.aspx" />
<meta name="twitter:description" content="Buy .com domain names. Buy one of the most popular domain extensions on the Internet with domain theft protection and 24/7 local support." />
...
<!-- <link rel="stylesheet" href="https://d1neo0gtmjcot5.cloudfront.net/assets/theme_v1/main_theme_v1.css?v=202502190136" media="all" /> -->
<link rel="stylesheet" href="https://genbaseerp.com/assets/css/custom.css?v=202502190136" media="all" />
<link rel="stylesheet" href="/assets/css/common.css?v=202502190136" media="all" />


<link rel="stylesheet" href="https://d1neo0gtmjcot5.cloudfront.net/assets/css/domain-landing.css?v=202502190136" media="all" />
...
<link rel="stylesheet" href="https://genbaseerp.com/assets/css/new-header23.css?v=202502190136" media="all" />
<link rel="stylesheet" href="assets/css/domain_registration.css?v=202502190136"/>
<link href="Styles/bootstrap.min.css" rel="stylesheet">
     <script src="JS/popper.min.js" ></script>
     <script src="JS/bootstrap.min.js" ></script>
...
<!-- </whatsapp-icon-hide-s> -->
                            <div class="banner-inner payment-banner  domain_banner_content" style="background-image: https://genbaseerp.com/assets/images/banner_bg.jpg;)">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="banner-content domain-content">
                        ...
                        <h1>Book .COM at <i class="fa fa-inr domain_rupeesicon" style="font-size: 40px;"></i> 949 <br>for 1st Year</h1>

                        <p>Renews at  &#8377; 1049/Yr</p>
            ...
            <div class="col-lg-9">
                    ...
                    <div class="registration-content content-box">
                        ...
                        <form method="post" action="domain_checker.aspx"  onsubmit="javascript: return joindomain();"> 
                            ...
                            <div class="search-domain-main">
                                ...
                                <span class="url-ending">.com</span>
                        ...
                        <div class="text-content">
                            ...
                            <p class="info-text">If you require assistance with com domain registration, please contact our helpdesk via <a href="mailto:info@hostitsmart.com" title="info@hostitsmart.com">email</a> or <a href="tel:079-3507-9700" title="telephone">telephone.</a>
                            </p>
                        </div>
                        <div class="more-domains">
                            <a href="https://genbaseerp.com/tld" title="More Domains Available" target="_blank">More Domains Available</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="domain-info-section content-box aos-init" data-aos="fade-left" data-aos-easing="ease-out-back">
                    ...
                    <div class="bulk-domain-section">
                        ...
                        <p class="instruction">
                            Register your com domain names in Bulk, simply enter your names below (one domain per line).
                        </p>
                        <form method="post"  action="bulk_domain_search.aspx"  onsubmit="javascript: return joinbulkdomain();"> 
                            <input type="hidden" id="_token" name="_token" value="EHRRPkGgW4JzPRZcZDT8jCb0J9bcMAF5YS6b2BBN"/>
                            <div class="search-bulk-domain-main">
                                <textarea rows="4"  name="bulkdomains" id="bulkdomains" cols="50" placeholder="yourdomain1.com yourdomain2.com"></textarea>
                            </div>
                ...
                <div class="left_panel d-sm-block d-none">
                    ...
                    <div class="extension_part aos-init" data-aos="fade-right" data-aos-easing="ease-out-back">
                        ...
                        <div class="extension_list mCustomScrollbar cms">
                            <ul>
                                                                                                                                                                    <li>
                                    <a href="buy_com_domain_names.aspx" class="featuared_active" title=".com">.com</a>
                                </li>
                                                                                                                                                                     <li>
                                    <a href="buy_info_domain_names.aspx" class="" title=".info">.info</a>
                                </li>
                                                                                                                                                                     <li>
                                    <a href="buy_org_domain_names.aspx" class="" title=".org">.org</a>
                                </li>
                                                                                                                                                                     <li>
                                    <a href="buy_in_domain_names.aspx" class="" title=".in">.in</a>
                                </li>
                                                                                                                                                                     <li>
                                    <a href="https://genbaseerp.com/domain/buy-mobi-domain-names" class="" title=".mobi">.mobi</a>
                                </li>
                                                                                                                                                                     <li>
                                    <a href="https://genbaseerp.com/domain/buy-properties-domain-names" class="" title=".properties">.properties</a>
                                </li>
                                                            </ul>
                        </div>
                    </div>
       ...
       // console.log(domainarray);
        for (var j = 0; j < domainarray.length; j++)
        {
            ...
            if (trim(domainarray[j]) != '')
            {
                ...
                if(_tld[1] === undefined){ domainarray[j] = domainarray[j]+"." + "com"}
...
<div id="browsernote" style="display:none;position:fixed;width:100%;height:100%;background:rgba(0,0,0,0.8);z-index:9999;top:0;left:0;font-size:18px;">
    <div style="font-size:18px;color:#fff;background:#18b35c;padding:15px;text-align:center;height:60px;z-index:9999;position:fixed;width:100%;top:0;margin:auto;">For a better experience on <strong style="color:#000;">Host IT Smart,</strong><a href="https://support.apple.com/downloads" style="cursor:pointer;color: #ffffff;font-size:14px;margin-left:10px;display:inline-block;" target="_blank">update your browser.</a>
        ...
        <!-- Main Wrapper E -->
                <!-- <script src="https://d1neo0gtmjcot5.cloudfront.net/assets/theme_v1/main_theme_v1.js?v=202502190136"></script> -->
...
<script src="assets/js/common_v12.js?v=202502190136" type="text/javascript" ></script>
...
document.addEventListener("DOMContentLoaded",function(){let e=document.querySelectorAll(".accordion-toggle");e.forEach(t=>{t.addEventListener("click",function(){if(window.innerWidth<=992){e.forEach(e=>{e!==t&&(e.classList.remove("active"),e.nextElementSibling.style.display="none")}),this.classList.toggle("active");let i=this.nextElementSibling;"block"===i.style.display?i.style.display="none":i.style.display="block"}})}),window.addEventListener("resize",function(){window.innerWidth>992&&e.forEach(e=>{e.classList.remove("active");let t=e.nextElementSibling;t.style.display=""})})});
    ...
    <!-- footer-menu-for-mobile-view-e -->            
            ...
            <script src="https://genbaseerp.com/assets/js/custom.js?v=202502190136"></script>
...
<script>
    ...
    const globalRequestParamTwo = 'buy-com-domain-names';
