<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="deals#Web_Hosting.aspx.cs" Inherits="Ditsmart.deals_Web_Hosting" %>
...
<title>Web Hosting Deals &amp; Offers : Upto 50% OFF on Web Hosting</title>

<meta name="description" content="Get the best Web Hosting deals &amp; offers on Hosting plans at Host IT Smart. You can save upto 50%-80% OFF on web hosting plans.">
<link rel="canonical" href="https://genbaseerp.com/deals" />
<link rel="alternate" href="https://genbaseerp.com/deals" hreflang="en-in" />
 
<link rel="alternate" hreflang="x-default" href="global.aspxdeals" />  
<link rel="alternate" href="global.aspxdeals" hreflang="en-us" />
<link rel="alternate" href="canada.aspxdeals" hreflang="en-ca" />
<meta name="author" content="">
<meta property="og:url" content="https://genbaseerp.com/deals" />
<meta property="og:type" content="website" />
<meta property="og:title" content="Web Hosting Deals &amp; Offers : Upto 50% OFF on Web Hosting" />
<meta property="og:description" content="Get the best Web Hosting deals &amp; offers on Hosting plans at Host IT Smart. You can save upto 50%-80% OFF on web hosting plans." />
<meta property="og:image" content="Images/logo.png" />
<meta name="twitter:card" content="Get the best Web Hosting deals &amp; offers on Hosting plans at Host IT Smart. You can save upto 50%-80% OFF on web hosting plans." />
<meta name="twitter:title" content="Web Hosting Deals &amp; Offers : Upto 50% OFF on Web Hosting" />
<meta name="twitter:url" content="https://genbaseerp.com/deals" />
<meta name="twitter:description" content="Get the best Web Hosting deals &amp; offers on Hosting plans at Host IT Smart. You can save upto 50%-80% OFF on web hosting plans." />
...
<!-- <link rel="stylesheet" href="https://d1neo0gtmjcot5.cloudfront.net/assets/theme_v1/main_theme_v1.css?v=202502190122" media="all" /> -->
<link rel="stylesheet" href="https://genbaseerp.com/assets/css/custom.css?v=202502190122" media="all" />
<link rel="stylesheet" href="/assets/css/common.css?v=202502190122" media="all" />


<link rel="stylesheet" href="https://d1neo0gtmjcot5.cloudfront.net/assets/css/domain-landing.css?v=202502190122" media="all" />
...
<link rel="stylesheet" href="https://genbaseerp.com/assets/css/new-header23.css?v=202502190122" media="all" />
<link rel="stylesheet" href="assets/css/deals.css?v=202502190122"/>
<link href="Styles/bootstrap.min.css" rel="stylesheet">
     <script src="JS/popper.min.js" ></script>
     <script src="JS/bootstrap.min.js" ></script>
            ...
            <ul class="nav nav-pills nav-deals d-md-flex d-none" data-aos="fade-up">      
                <li class="col text-center nav-item">
                    <a data-toggle="pill" href="#all-deals" title="All Offers" class="nav-link active" id="alloffer1">All Offers</a></li>
                                                <li class="col text-center nav-item" id="Web-Hosting" >
                    <a class="nav-link" data-toggle="pill" href="#1" title="Web Hosting" id="Web-Hosting1">Web Hosting</a></li>
                                                <li class="col text-center nav-item" id="Combo-Plans" >
                    <a class="nav-link" data-toggle="pill" href="#2" title="Combo Plans" id="Combo-Plans1">Combo Plans</a></li>
                                                <li class="col text-center nav-item" id="SERVERS" >
                    <a class="nav-link" data-toggle="pill" href="#3" title="SERVERS" id="SERVERS1">SERVERS</a></li>
            ...
            <div class="dropdown d-md-none d-block">
                <select class="form-control selectpicker" id='ProductTitle'>
                    <option class="deals-tab-responsive">All Offers</option>
                                        <option class="deals-tab-responsive"  value="1">Web Hosting</option>
                                        <option class="deals-tab-responsive"  value="2">Combo Plans</option>
                                        <option class="deals-tab-responsive"  value="3">SERVERS</option>
                                    </select>
            </div>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="deal-body">
                ...
                <div class="promo">
                    <a href="https://genbaseerp.com" class="btn">Buy now</a>
               </div>
            </div>
        </div>
...
<script type="text/javascript">
    function applyPromocode(promocode , popupname){
        ...
        $.ajax({
            async:false,
            url:"https://genbaseerp.com/cart/converttowhmcs",
            data:{"_token":"EHRRPkGgW4JzPRZcZDT8jCb0J9bcMAF5YS6b2BBN"},
            type:"post",
            success:function(res1){
                response1 = res1;
                $.ajax({
                async:false,
                url:"https://manage.hostitsmart.com"+"/updatecart.php",
                ...
                success:function(res2){
                        ...
                        $.ajax({
                        async:false,                            
                        url:"https://manage.hostitsmart.com"+"clientarea_cart.aspx?a=view",
      ...
      function updatePromoCode(action,promo='',amount='',prmomessage=''){
        var formData = {"_token":"EHRRPkGgW4JzPRZcZDT8jCb0J9bcMAF5YS6b2BBN","action":action,"promo":promo,"discount":amount,"prmomessage":prmomessage};
        $.ajax({
            async:false,
            beforeSend: function () { showLoader(); },
            url:"https://genbaseerp.com/cart/updatepromo",
            data:formData,
            type:"post",
...
<div id="browsernote" style="display:none;position:fixed;width:100%;height:100%;background:rgba(0,0,0,0.8);z-index:9999;top:0;left:0;font-size:18px;">
    <div style="font-size:18px;color:#fff;background:#18b35c;padding:15px;text-align:center;height:60px;z-index:9999;position:fixed;width:100%;top:0;margin:auto;">For a better experience on <strong style="color:#000;">Host IT Smart,</strong><a href="https://support.apple.com/downloads" style="cursor:pointer;color: #ffffff;font-size:14px;margin-left:10px;display:inline-block;" target="_blank">update your browser.</a>
        ...
        <!-- Main Wrapper E -->
                <!-- <script src="https://d1neo0gtmjcot5.cloudfront.net/assets/theme_v1/main_theme_v1.js?v=202502190122"></script> -->
...
<script src="assets/js/common_v12.js?v=202502190122" type="text/javascript" ></script>
...
document.addEventListener("DOMContentLoaded",function(){let e=document.querySelectorAll(".accordion-toggle");e.forEach(t=>{t.addEventListener("click",function(){if(window.innerWidth<=992){e.forEach(e=>{e!==t&&(e.classList.remove("active"),e.nextElementSibling.style.display="none")}),this.classList.toggle("active");let i=this.nextElementSibling;"block"===i.style.display?i.style.display="none":i.style.display="block"}})}),window.addEventListener("resize",function(){window.innerWidth>992&&e.forEach(e=>{e.classList.remove("active");let t=e.nextElementSibling;t.style.display=""})})});
    ...
    <!-- footer-menu-for-mobile-view-e -->            
            ...
            <script src="https://genbaseerp.com/assets/js/custom.js?v=202502190122"></script>
...
<script>
    ...
    const globalRequestParamOne = 'deals';
