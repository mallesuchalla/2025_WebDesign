<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="store_windows_vps_hosting.aspx.cs" Inherits="Ditsmart.store_windows_vps_hosting" %>
    ...
    <div class="row">
                ...
                <i class="fas fa-chevron-up card-minimise panel-minimise pull-right float-right"></i>
                    ...
                    <div class="list-group collapsable-card-body">
                            ...
                            Linux Managed VPS Hosting
                                                                                ...
                                                                                <a menuItemName="Windows VPS Hosting" href="store_windows_vps_hosting.aspx" class="list-group-item list-group-item-action active" id="Secondary_Sidebar-Categories-Windows_VPS_Hosting">
        ...
        <div class="panel-heading card-header">
            <h3 class="panel-title">
                ...
                <form method="post" action="store_windows_vps_hosting.aspx">
        ...
        <form role="form">
            <select class="form-control custom-select" onchange="selectChangeNavigate(this)">
                        ...
                        Linux Managed VPS Hosting
                                                        ...
                                                        <option menuItemName="Windows VPS Hosting" value="store_windows_vps_hosting.aspx" class="list-group-item" selected="selected">
                        Windows VPS Hosting
            ...
            <div class="products" id="products">
                <div class="row row-eq-height">
                        ...
                        <div class="product clearfix" id="product512">
                            <header>
                                <span id="product512-name">WIN VPS - SM 1 - 2025</span>
                                                            </header>
...
1 Dedicated IP<br />
                            ...
                            <footer>
                                <div class="product-pricing" id="product512-price">
                                                                                                                        Starting from
                                            <br />
                                                                                <span class="price">INR 1,155.00</span>
                                        <br />
                                                                                    Monthly
                                                                                <br>
                                                                                                            </div>
                                <a href="store_windows_vps_hosting.aspx/win-vps-sm-1-2025" class="btn btn-success btn-sm" id="product512-order-button">
                                    <i class="fas fa-shopping-cart"></i>
                                    Order Now
                                </a>
                            </footer>
                        ...
                        <div class="product clearfix" id="product513">
                            <header>
                                <span id="product513-name">WIN VPS - SM 2 - 2025</span>
                                                            </header>
                            <div class="product-desc">
...
1 Dedicated IP<br />
                            ...
                            <footer>
                                <div class="product-pricing" id="product513-price">
                                                                                                                        Starting from
                                            <br />
                                                                                <span class="price">INR 1,785.00</span>
                                        <br />
                                                                                    Monthly
                                                                                <br>
                                                                                                            </div>
                                <a href="store_windows_vps_hosting.aspx/win-vps-sm-2-2025" class="btn btn-success btn-sm" id="product513-order-button">
                                    <i class="fas fa-shopping-cart"></i>
                                    Order Now
                                </a>
                            </footer>
                ...
                <div class="row row-eq-height">
                        ...
                        <div class="product clearfix" id="product515">
                            <header>
                                <span id="product515-name">WIN VPS - SM 4 - 2025</span>
                                                            </header>
                            <div class="product-desc">
...
1 Dedicated IP<br />
                            ...
                            <footer>
                                <div class="product-pricing" id="product515-price">
                                                                                                                        Starting from
                                            <br />
                                                                                <span class="price">INR 6,615.00</span>
                                        <br />
                                                                                    Monthly
                                                                                <br>
                                                                                                            </div>
                                <a href="store_windows_vps_hosting.aspx/win-vps-sm-4-2025" class="btn btn-success btn-sm" id="product515-order-button">
                                    <i class="fas fa-shopping-cart"></i>
                                    Order Now
                                </a>
                            </footer>
                        ...
                        <div class="product clearfix" id="product514">
                            <header>
                                <span id="product514-name">WIN VPS - SM 3 - 2025</span>
                                                            </header>
                            <div class="product-desc">
...
1 Dedicated IP<br />
                            ...
                            <footer>
                                <div class="product-pricing" id="product514-price">
                                                                                                                        Starting from
                                            <br />
                                                                                <span class="price">INR 3,395.00</span>
                                        <br />
                                                                                    Monthly
                                                                                <br>
                                                                                                            </div>
                                <a href="store_windows_vps_hosting.aspx/win-vps-sm-3-2025" class="btn btn-success btn-sm" id="product514-order-button">
                                    <i class="fas fa-shopping-cart"></i>
                                    Order Now
                                </a>
                            </footer>
